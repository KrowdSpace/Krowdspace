    ...
    <div class="row dash-body-row">
        <div class="dash-offset-left">
            ...
            <div class="dash-bottom-box-bottom">
                <a href="/#/project/{ campaignLink }"><button class="btn btn-primary dash-buttons"><img alt="Krowdspace" src="/images/krowdspace-logo-white.svg" class="krowdspace" aria-hidden="true" />
        <span class="dash-buttons-text project-id-btn"> Project Link</span>
        </button></a>
        <a show= { campaignSwitch } href="{ ownerLink }" target="_blank"><button class="btn btn-primary dash-buttons"><img alt="Kickstarter" src="/images/kickstarter.svg" class="kickstarter" aria-hidden="true" />
        <span class="dash-buttons-text"> Campaign Link</span>
        </button></a>
        <a show= { !campaignSwitch } href="{ ownerLink }" target="_blank">
                <button class="btn btn-primary dash-buttons"><img alt="Indiegogo" src="/images/indiegogo.svg" class="indiegogo" aria-hidden="true" />
          <span class="dash-buttons-text"> Campaign Link</span>
          </button></a>
            </div>
        </div>
