<registration-form>
    <div class="row project-form-flex">
            <div class="register-form-box">
                <button class="btn btn-primary register-btn-kickstarter" onClick={ kickstarterForm }><img alt="Kickstarter" src="/images/kickstarter-full.svg" class="kickstarter-full"></button>
                <button class="btn btn-primary register-btn-indiegogo" onClick={ indiegogoForm }><img alt="Indiegogo" src="/images/indiegogo-full.svg" class="indiegogo-full"></button>
                ...
                <form id="registrationForm" onsubmit={ submission }>
                    ...
                    <div class="col-xs-12 submission_terms">
                      <img alt="Krowdspace Featured" src="/images/krowdspace-featured.svg" class="img-responsive krowdspace-featured">
