         ...
         <div id="modal">
            <div class="modal-body">
                <div class="col-sm-12 edit-user-box">
                     ...
                     <p class="registration-text text-left" style="margin-top: 15px;">To support this project and receive the posted reward make sure to send the below COUPON CODE after completing your pledge. All project owners have agreed to fulfill any and all rewards posted on their project page.</p>
                ...
                <div class="text-center">
                    ...
                    <p class="landing-submit alt-border" style="border-bottom: none;">SUPPORT PROJECT</p>
                    </a>
                </div>
            </div>
         </div>
