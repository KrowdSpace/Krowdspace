                ...
                <div class="modal-body">
                    <div>
                        ...
                        <div class="col-md-4 hidden-sm hidden-xs featured-image-box">
                            <img class="img-responsive featured-img" alt="Featured Purchase" src="/img/content/featured-purchase.jpg"/>
                        </div>
                    </div>
                    <div>
                        <div class="col-md-8 featured-text-box">
                        ...
                        <div class="col-md-4 hidden-sm hidden-xs featured-image-box">
                            <img class="img-responsive featured-img" alt="Explore Purchase" src="/img/content/explore-purchase.jpg"/>
                        </div>
                    </div>
                    <div>
                        <div class="col-md-8 featured-text-box">
                        ...
                        <div class="col-sm-4 hidden-sm hidden-xs featured-image-box">
                            <img class="img-responsive featured-img" alt="Landing Purchase" src="/img/content/landing-purchase.jpg"/>
                        </div>
                    </div>
                    <div>
                        <div class="col-md-8 featured-text-box">
                        ...
                        <div class="col-sm-4 hidden-sm hidden-xs featured-image-box">
                            <img class="img-responsive featured-img" alt="Social Media Purchase" src="/img/content/social-purchase.jpg"/>
                        </div>
                    </div>
                </div>
