<global-modal-rewards>
    <div id="modal-global-rewards" class="modal container padding-reset fade">
        <div class="krowdspace-modal col-sm-8 col-sm-offset-2">
            <div id="modal" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="legal-text">To submit a project from Indiegogo you will need to provide your "Secret Perks" link and a description of one of your Secret Perks. Using Krowdspace will open up new opportunities and get your project viewed by not only an Indiegogo audience but a Kickstarter audience as well. </p>
                    <p class="privacy-title">REWARD EXAMPLES</p>
                    <div class="reward-examples">
                    <p class="text-reset">- All Krowdspace members will have continued access to Early Bird Pricing.</p>
                    <p class="text-reset">- All Krowdspace members will get a free upgrade to the next tier automatically.</p>
                    <p class="text-reset">- Krowdspace members will get to choose from additional colors that won’t be available to anyone else.</p>
                    <p class="text-reset">- If you back our 3 bundle tier we will send you an extra bundle free.</p>
                    <p class="text-reset">- All Krowdspace members will be given protective cases with your pledge item.</p>
                    <p class="text-reset">- All Krowdspace members who back over $50 will receive another item free.</p>
