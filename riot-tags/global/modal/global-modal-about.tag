                    ...
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="text-left">
                                    <p class="about-heading">October 2016</p>
                                    <p class="about-heading">The Crowdfunding Experiment</p>
                                    <div class="text-left">
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="text-left">
                                    <p class="about-heading">November 2016</p>
                                    <p class="about-heading">The Seed is Planted</p>
                                    <div class="text-left">
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="text-left">
                                    <p class="about-heading">December 2016</p>
                                    <p class="about-heading">Krowdspace is Born</p>
                                    <div class="text-left">
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="text-left">
                                    <p class="about-heading">January 2017</p>
                                    <p class="about-heading">Building our Platform</p>
                                    <div class="text-left">
                        ...
                        <li class="timeline">
                            ...
                            <div class="timeline-panel">
                                <div class="text-left">
                                    <p class="about-heading">March 2017</p>
                                    <p class="about-heading">Krowdspace Launch</p>
                                    <div class="text-left">
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="text-left">
                                    <p class="about-heading">June 2017</p>
                                    <p class="about-heading">Finish Strong</p>
                                    <div class="text-left">
                        ...
                        <li class="timeline time-bottom">
                            ...
                            <div class="timeline-panel">
                                <div class="text-left">
                                    <p class="about-heading">Krowdspace</p>
                                    <div class="text-left">
