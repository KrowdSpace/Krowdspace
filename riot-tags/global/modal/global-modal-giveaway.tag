        ...
        <div class="krowdspace-modal col-sm-10 col-sm-offset-1" style="margin-bottom: 0px;">
            <div id="modal" class="modal-content text-center">
                <div class="modal-header">
                    ...
                    <p class="modal-heading">KROWDSPACE GIVEAWAY - PARTY PACK</p>
                    <iframe style="width: 100%; height: 1100px; overflow: hidden;" src="https://gleam.io/XsDXo/krowdspace-party-pack-giveaway" frameBorder="0" allowfullscreen></iframe>
                    <p class="modal-heading text-left">Previous Giveaway Winners</p>
                    <p class="giveaway-winner text-left"><strong>$50 Amazon Card - 04/01/17</strong></p>
                    <p class="giveaway-winner text-right"><strong>$75 K POP Prize Package - 05/25/17</strong></p>
                    <p class="giveaway-winner text-left"><strong>$60 Krowdspace Party Pack - 07/25/17</strong></p>
                </div>
            </div>
        </div>
        <div class="krowdspace-modal col-sm-10 col-sm-offset-1 text-left">
            <div id="modal" class="modal-content">
                <div class="modal-header">
                    ...
                    <br>
                    <p><span class="modal-text"><strong>Campaign Period:</strong></span> Entries will be accepted online starting on 06/13/17 18:00PM PST and ending on 07/25/17 11:59PM PST. All online entries must be received by 07/25/17 11:59PM PST.</p>
                    <br>
                    ...
                    <br>
                    <p><span class="modal-text"><strong>Winners List:</strong></span> To obtain a copy of the Winner’s name or a copy of these Official Rules, mail your request along with a stamped, self-addressed envelope to: Krowdspace 10333 Main Street Apt 342, Bellevue, WA 98004. Requests must be received no later than 06/25/17.</p>
                    <br>
