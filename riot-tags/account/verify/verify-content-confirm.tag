<verify-content-confirm>
    <div class="row row-verify">
        ...
        <div class="col-sm-12"><p style="padding-bottom: 10px;">Enjoy our...</p></div>
        <div class="col-sm-4 text-left" style="padding-top: 15px;">
    ...
    <div class="row">
        <div class="col-sm-7"><p>Would you like to submit your own crowdfunding project to Krowdspace?</p></div>
