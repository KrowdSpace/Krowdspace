         ...
         <div id="modal">
               <form id="submitRefresh" role="form" onsubmit={ submitRefresh }>
                  <div class="edit-user-box modal-max-login" style="position: relative;">
                     ...
                     <p class="modal-purchase-text">Warning: Updating your project after it has completed on Kickstarter or Indiegogo will reset some of our Krowdspace metrics. </p>
