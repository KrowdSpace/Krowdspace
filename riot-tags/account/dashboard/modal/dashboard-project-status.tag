<dashboard-project-status>
   <div id="project-status" class="modal container fade">
      <div class="krowdspace-modal-custom col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8" style="padding: 0px;">
         <div id="modal">
            <div class="edit-user-box modal-max-login" style="position: relative; padding-bottom: 15px;">
             ...
             <img class="project-approval-modal" src="/img/content/project-status-vertical.svg">
                <p class="modal-heading">Project Status</p>
