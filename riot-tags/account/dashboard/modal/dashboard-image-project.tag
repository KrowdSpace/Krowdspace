         ...
         <div id="modal" class="no-gutter">
            <form role="form" onsubmit={ imageRefresh }>
                <div class="modal-box modal-max-box">
                    ...
                    <p class="text-left edit-text-title">Krowdspace is using your main project image from Indiegogo. To have the best user experience at Krowdspace please upload a video image overlay to your Indiegogo project page. This will fix the black padding you see on either side of the current image.</p>
