<dashboard-project-reward>
    <div class="col-lg-6 col-md-12 reward-container">
        <div class="shadow dashboard-reward-box">
            ...
            <p class="dashboard-text-alt disclaimer-text">Upon succesful completion of your crowdfunding project you have agreed to send out any additional rewards to the backers who have supported your campaign. Please use the below reward code to validate backers coming from Krowdspace for Kickstarter campaigns.</p>
