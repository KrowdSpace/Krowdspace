                    ...
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1 shadow user-modal">
                            <div class="row">
                                ...
                                <div class="text-right col-sm-6 hidden-xs" style="margin-top:15px;">
                                    <a href="/?login=1" data-toggle="modal" class="boost-purchase">Join Krowdspace</a>
                                </div>
                            </div>
                            <div class="text-left">
                            ...
                            <div class="row text-left boost-padding">
                                <div class="col-md-4">
