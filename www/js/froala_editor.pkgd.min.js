...
! function(a) {
    ...
    if (a.FE.LinkRegExCommon = "(([" + c + "])|([" + c + "](\\.|-|_))){1,}[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|())((\\/[a-z\\u00a1-\\uffff0-9@?^=%&amp;/~+#-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/(www\\.)?" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/(www\\.)?[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(((ftp|http|https):\\/\\/)?www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExAuth + "|" + a.FE.LinkRegExWWW + ")" + a.FE.LinkRegExEnd, a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function(b) {
            ...
            placeholderText: "Copy and Paste your Project Content Here!"
            ...
            toolbarBottom: !1,
            toolbarButtons: ["bold", "italic", "underline", "subscript", "superscript", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "insertLink", "insertImage", "insertVideo", "insertHR", "selectAll", "clearFormatting", "|", "spellChecker", "html", "|", "undo", "redo"],
            toolbarButtonsXS: ["bold", "italic", "fontSize", "|", "undo", "redo"],
            toolbarButtonsSM: ["bold", "italic", "underline", "|", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"],
            toolbarButtonsMD: ["bold", "italic", "underline", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "insertLink", "insertImage", "insertVideo", "selectAll", "clearFormatting", "|", "spellChecker", "html", "|", "undo", "redo"],
            ...
            function f() {
                if (b.opts.charCounterCount) {
                    ...
                    d >= 0 && ("rtl" == b.opts.direction ? h.css("margin-left", d) : h.css("margin-right", 0))
                }
            }
