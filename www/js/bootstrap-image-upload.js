...
(function($) {
    ...
    function init(givenOptions) {
        ...
        var $fileTabButton = $imageupload.find('.panel-image .btn:eq(0)');
        ...
        var $urlTabButton = $imageupload.find('.panel-image .btn:eq(1)');
    ...
    function getImageThumbnailHtml(src) {
        return '<img src="' + src + '" alt="Image preview" id="PIMAGE" name="PIMAGE" class="thumbnail" style="max-width: ' + options.maxWidth + 'px; max-height: ' + options.maxHeight + 'px">';
    }
    ...
    function showFileTab($fileTab) {
        ...
        if (!$fileTabButton.hasClass('active')) {
            ...
            $imageupload.find('.panel-image .btn:eq(1)').removeClass('active');
    ...
    function resetFileTab($fileTab) {
        ...
        $fileTab.find('.btn span').text('Upload From Desktop');
    ...
    function submitImageFile($fileTab) {
        ...
        $fileTab.find('.alert').remove();
        $fileTab.find('img').remove();
        $browseFileButton.find('span').text('Upload From Desktop');
    ...
    function showUrlTab($urlTab) {
        ...
        if (!$urlTabButton.hasClass('active')) {
            ...
            $imageupload.find('.panel-image .btn:eq(0)').removeClass('active');
