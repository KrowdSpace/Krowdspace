...
riot.tag2('admin-page', '<global-logout class="hidden-xs" show="{logged_in}" uri="{opts.uri}"></global-logout> <div class="col-sm-12 text-left admin-container row-verify padding-reset shadow"> <div class="col-sm-12 admin-box no-gutter"> <div class="col-sm-1"> <p class="admin-text">NAME</p> </div> <div class="col-sm-6"> <p class="admin-text">REWARD</p> </div> <div class="col-sm-1 text-center"> <p class="admin-text">FEATURE</p> </div> <div class="col-sm-1 text-center"> <p class="admin-text">EXPLORE</p> </div> <div class="col-sm-1 text-center"> <p class="admin-text">LANDING</p> </div> <div class="col-sm-1 text-center"> <p class="admin-text">SOCIAL</p> </div> <div class="col-sm-1 text-center"> <p class="admin-text">REWARD</p> </div> </div> <form> <div class="col-sm-12 admin-data-box no-gutter" each="{adminData}"> <div class="col-sm-1"> <p class="admin-text">{unique_id}</p> </div> <div class="col-sm-6"> <p class="admin-text">{project_data.info_data.reward}</p> </div> <div class="col-sm-1 text-center"> <input checked="{project_data.info_data.featured}" input type="checkbox"> </div> <div class="col-sm-1 text-center"> <input checked="{project_data.info_data.explore}" input type="checkbox"> </div> <div class="col-sm-1 text-center"> <input checked="{project_data.info_data.landing}" input type="checkbox"> </div> <div class="col-sm-1 text-center"> <input checked="{project_data.info_data.social}" input type="checkbox"> </div> <div class="col-sm-1 text-center"> <input class="admin-radio" checked="{project_data.info_data.rewardValid == \'1\'}" name="{unique_id}" type="radio" value="1"> <input class="admin-radio" checked="{project_data.info_data.rewardValid == \'0\'}" name="{unique_id}" type="radio" value="0"> <input class="admin-radio" checked="{project_data.info_data.rewardValid == \'2\'}" name="{unique_id}" type="radio" value="2"> </div> </div> <div class="col-sm-12 padding-reset"> <input type="submit" class="admin-comment-submit" name="submit" value="Update Project Database"> </div> </form> </div> <div class="col-sm-12 text-left admin-container padding-reset shadow"> <div class="col-sm-12 admin-box no-gutter"> <div class="col-sm-2"> <p class="admin-text">NAME</p> </div> <div class="col-sm-3"> <p class="admin-text">EMAIL</p> </div> <div class="col-sm-6"> <p class="admin-text">COMMENT</p> </div> <div class="col-sm-1 text-center"> <p class="admin-text">READ</p> </div> </div> <form> <div class="col-sm-12 admin-data-box no-gutter"> <div class="col-sm-2"> <p class="admin-text">Mason Halstead</p> </div> <div class="col-sm-3"> <p class="admin-text">Mason@krowdspace.com</p> </div> <div class="col-sm-6"> <p class="admin-text">Comment can go here.</p> </div> <div class="col-sm-1 text-center"> <input class="admin-radio-alt" name="uniqueID" type="radio" value="0"> <input class="admin-radio-alt" name="uniqueID" type="radio" value="1"> </div> </div> <div class="col-sm-12 padding-reset"> <input type="submit" class="admin-comment-submit" name="submit" value="Remove Read Comments"> </div> </form> </div>', '', '', function(opts) {
...
riot.tag2('dashboard-user', '<div class="col-md-6 text-left no-gutter project-user-container"> <a href="#edit-profile" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn filterdark float-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-pencil fa-stack-1x fa-inverse"></i> </span> </a> <p class="profile-name capital">{firstname || \'Firstname\'} {lastname || \'Lastname\'}</p> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break">Username:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break capital">{username || \'Username\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user">Email:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user capital">{email || \'Email Address\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break hidden-md">Kickstarter Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break hidden-md capital">{kickstarter || \'N/A\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user hidden-md">Indiegogo Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user hidden-md capital">{indiegogo || \'N/A\'}</p> </div> <div class="user-position-box"> <p class="dashboard-text profile-name">Krowdspace Campaigns</p> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Kickstarter</p> <p class="social-metric">{projectTotal}</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Indiegogo</p> <p class="social-metric">{projectTotal}</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Rewards</p> <p class="social-metric">${krowdspaceTotalReward}</p> </div> </div> <div class="clearfix"></div> </div>', '@media screen and (max-width: 1200px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 224px; } } @media screen and (max-width: 991px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 300px; border-left:1px solid #000; } } @media screen and (max-width: 767px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ width: 400px; margin-left: auto; margin-right: auto; } }', '', function(opts) {
this.on('mount', () => {
