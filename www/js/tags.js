...
riot.tag2('dashboard-user', '<div class="col-md-6 text-left no-gutter project-user-container"> <a href="#edit-profile" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn filterdark float-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-pencil fa-stack-1x fa-inverse"></i> </span> </a> <p class="profile-name capital">{firstname || \'Firstname\'} {lastname || \'Lastname\'}</p> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break">Username:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break capital">{username || \'Username\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user">Email:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user capital">{email || \'Email Address\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break hidden-md">Kickstarter Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break hidden-md capital">{kickstarter || \'N/A\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user hidden-md">Indiegogo Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user hidden-md capital">{indiegogo || \'N/A\'}</p> </div> <div class="user-position-box"> <p class="dashboard-text profile-name">Krowdspace Campaigns</p> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Kickstarter</p> <p class="social-metric">{kickstarterTotal}</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Indiegogo</p> <p class="social-metric">{indiegogoTotal}</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Rewards</p> <p class="social-metric">${krowdspaceTotalReward}</p> </div> </div> <div class="clearfix"></div> </div>', '@media screen and (max-width: 1200px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 224px; } } @media screen and (max-width: 991px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 300px; border-left:1px solid #000; } } @media screen and (max-width: 767px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ width: 400px; margin-left: auto; margin-right: auto; } }', '', function(opts) {
this.on('mount', () => {
