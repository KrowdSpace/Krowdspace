...
riot.tag2('dashboard-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container dashboard"> <div class="shadow text-center project-add-container"> <p class="project-add-text">PROJECT</p> <div each="{p, index in projects}"> <project-button onclick="{makeButtF(p)}" project="{p}">{project.unique_id}</project-button> </div> <a href="/#/account/register"> <i class="fa fa-plus project-add-btn filterdark"></i> </a> </div> <global-logout show="{logged_in}"></global-logout> <div class="col-sm-10 col-sm-offset-1" style="padding: 0px;"> <div class="row dash-row no-gutter shadow"> <dashboard-project-image show="{project}" project="{project}"></dashboard-project-image> <dashboard-user-image show="{!project}"></dashboard-user-image> <dashboard-project-user index="{projectIndex + 1}" user="{user}" project="{project}"></dashboard-project-user> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-hours project="{project}"></dashboard-project-hours> <dashboard-project-reward project="{project}"></dashboard-project-reward> </div> <div show="{project}" class="row dash-row no-gutter shadow"> <dashboard-project-title project="{project}"> </dashboard-project-title> </div> <div class="row dash-row no-gutter shadow"> <dashboard-project-bar show="{project}" project="{project}"></dashboard-project-bar> <dashboard-user-bar show="{!project}"></dashboard-user-bar> </div> </div> </div> <dashboard-featured-purchase user="{user}" project="{project}"></dashboard-featured-purchase> <dashboard-explore-purchase user="{user}" project="{project}"></dashboard-explore-purchase> <dashboard-landing-purchase user="{user}" project="{project}"></dashboard-landing-purchase> <dashboard-social-purchase user="{user}" project="{project}"></dashboard-social-purchase> <dashboard-edit-profile user="{user}" project="{project}"></dashboard-edit-profile> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <dashboard-refresh-content user="{user}" project="{project}"></dashboard-refresh-content> <global-footer></global-footer>', '', '', function(opts) {
	this.projectNum = 0;
	this.projectIndex = 0;
	this.projects = [];
...
riot.tag2('dashboard-project-title', '<div class="col-sm-12 dashboard-title-container no-gutter"> <div class="col-sm-4 divider-inside-right dashboard-title-box"> <p class="dashboard-text-alt">{projectTitle}</p> <p class="dashboard-text-alt description-text">{projectDescription}</p> </div> <div class="col-sm-8 no-gutter text-center"> <div class="col-sm-4 text-center feature-box"> <div style="position: relative;"> <a href="#purchase-featured" class="modal-link" data-toggle="modal"> <img class="img-responsive feature-buy" src="/img/content/featured-purchase.jpg"> <div class="filter-background"> <p class="featured-text-buy">FEATURED ICON</p> </div> </a> </div> </div> <div class="col-sm-4 feature-box"> <div style="position: relative;"> <a href="#purchase-explore" class="modal-link" data-toggle="modal"> <img class="img-responsive feature-buy" src="/img/content/explore-purchase.jpg"> <div class="filter-background"> <p class="featured-text-buy">EXPLORE BANNER</p> </div> </div><a></a> </div> <div class="col-sm-4 feature-box"> <div style="position: relative;"> <a href="#purchase-landing" class="modal-link" data-toggle="modal"> <img class="img-responsive feature-buy" src="/img/content/landing-purchase.jpg"> <div class="filter-background"> <p class="featured-text-buy">LANDING BANNER</p> </div> </div><a></a> </div> </div> </div>', '', '', function(opts) {
    this.on('update', ()=>
    {
        if(!opts.project)
            return;
...
riot.tag2('dashboard-user-image', '<div class="col-sm-6 image-container"> <div class="single-item slider"> <div class="dash-banner-box" each="{ExploreBannerFilter}"> <img riot-src="{project_data.web_data.mainImg.content}" alt="{project_data.web_data.description.content}"> <div class="explore-box"> <div class="col-sm-9"> <div style="position: relative; height: 280px;"> <div class="explore-feature-left"> <div class="dash-box-text"> <span class="dash-user-title">{name}</span> </div> <div class="dash-box-text"> <span class="dash-user-title">{project_data.info_data.reward}</span> </div> </div> </div> </div> <div class="col-sm-3 dash-feature-right text-center"> <a href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><p class="learn-more">Learn More</p></a> </div> </div> </div> </div> </div>', 'dashboard-user-image .slider,[data-is="dashboard-user-image"] .slider{ width: 100%; position: relative; margin: 0px auto; } dashboard-user-image .slick-slide,[data-is="dashboard-user-image"] .slick-slide{ margin: 0px; } dashboard-user-image .slick-slide span,[data-is="dashboard-user-image"] .slick-slide span,dashboard-user-image .slick-slide .learn-more,[data-is="dashboard-user-image"] .slick-slide .learn-more{ display: none; } dashboard-user-image .slick-current span,[data-is="dashboard-user-image"] .slick-current span,dashboard-user-image .slick-current .learn-more,[data-is="dashboard-user-image"] .slick-current .learn-more{ display: inline; } dashboard-user-image .slick-slide img,[data-is="dashboard-user-image"] .slick-slide img{ width: 515px; overflow: hidden; }', '', function(opts) {
...
riot.tag2('dashboard-user-reward', '<div class="col-sm-12 dashboard-reward-container" style="padding-left: 0px;"> <div class="dashboard-user-box shadow"> <p class="dashboard-text-alt reward-text">Get extra rewards for supporting project with Krowdspace!</p> <p class="dashboard-text-alt disclaimer-text">To find out how to receive extra rewards, click on the "Back Project" button located on every project page. Depending on the crowdfunding site will depend on how to receive the reward. Start your search today and check out our <a href="/#/explore" class="home-links">Explore Page</a>.</p> </div> </div>', '', '', function(opts) {
});	
...
riot.tag2('dashboard-explore-purchase', '<div id="purchase-explore" class="modal container fade"> <div class="krowdspace-modal col-lg-offset-2 col-md-8"> <div id="modal"> <div class="modal-body modal-purchase no-gutter"> <div class="col-sm-7 purchase-container-left"> <p class="modal-heading">EXPLORE PAGE BANNER</p> <p class="modal-purchase-text text-left">Your project will be listed on our Explore Page with a featured project icon. Having your project featured means it will get priority filtering and have increased viewership. For a limited time we are offering this as a free service while we work through our initial launch! Please click the Upgrade button below to add this feature.</p> </div> <div class="col-sm-5 purchase-container-right"> <img class="img-responsive" src="/img/content/explore-purchase.jpg"> <div class="purchase-price-box no-gutter"> <div class="col-sm-6 text-center divider-inside-right"> <p class="purchase-text">EXPLORE BANNER</p> </div> <div class="col-sm-6 text-center"> <p class="purchase-text-right">FREE</p> </div> <div class="clearfix"></div> </div> <div> <form id="purchaseExplore" role="form" onsubmit="{submitExplore}"> <div class="text-center"> <input class="landing-submit alt-border" style="border-bottom: none;" type="submit" name="submit" value="Upgrade" class="btn-register"> </div> </form> </div> </div> </div> </div> </div> </div>', '', '', function(opts) {
   this.on('update', ()=>
    {
        if(!opts.project)
            return;
...
riot.tag2('dashboard-featured-purchase', '<div id="purchase-featured" class="modal container fade"> <div class="krowdspace-modal col-lg-offset-2 col-md-8"> <div id="modal"> <div class="modal-body modal-purchase no-gutter"> <div class="col-sm-7 purchase-container-left"> <p class="modal-heading">FEATURED PROJECT LISTING</p> <p class="modal-purchase-text text-left">Your project will be listed on our Explore Page with a featured project icon. Having your project featured means it will get priority filtering and have increased viewership. For a limited time we are offering this as a free service while we work through our initial launch! Please click the Upgrade button below to add this feature.</p> </div> <div class="col-sm-5 purchase-container-right"> <img class="img-responsive" src="/img/content/featured-purchase.jpg"> <div class="purchase-price-box no-gutter"> <div class="col-sm-6 text-center divider-inside-right"> <p class="purchase-text">FEATURED ICON</p> </div> <div class="col-sm-6 text-center"> <p class="purchase-text-right">FREE</p> </div> <div class="clearfix"></div> </div> <div> <form id="purchaseFeature" role="form" onsubmit="{submitFeatured}"> <div class="text-center"> <input class="landing-submit alt-border" style="border-bottom: none;" type="submit" name="submit" value="Upgrade" class="btn-register"> </div> </form> </div> </div> </div> </div> </div> </div>', '', '', function(opts) {
        this.on('update', ()=>
         {
             if(!opts.project)
                 return;
...
riot.tag2('dashboard-landing-purchase', '<div id="purchase-landing" class="modal container fade"> <div class="krowdspace-modal col-lg-offset-2 col-md-8"> <div id="modal"> <div class="modal-body modal-purchase no-gutter"> <div class="col-sm-7 purchase-container-left"> <p class="modal-heading">LANDING PAGE BANNER</p> <p class="modal-purchase-text text-left">Your project will be listed on our Explore Page with a featured project icon. Having your project featured means it will get priority filtering and have increased viewership. For a limited time we are offering this as a free service while we work through our initial launch! Please click the Upgrade button below to add this feature.</p> </div> <div class="col-sm-5 purchase-container-right"> <img class="img-responsive" src="/img/content/landing-purchase.jpg"> <div class="purchase-price-box no-gutter"> <div class="col-sm-6 text-center divider-inside-right"> <p class="purchase-text">LANDING BANNER</p> </div> <div class="col-sm-6 text-center"> <p class="purchase-text-right">FREE</p> </div> <div class="clearfix"></div> </div> <div> <form id="purchaseLanding" role="form" onsubmit="{submitLanding}"> <div class="text-center"> <input class="landing-submit alt-border" style="border-bottom: none;" type="submit" name="submit" value="Upgrade" class="btn-register"> </div> </form> </div> </div> </div> </div> </div> </div>', '', '', function(opts) {
   this.on('update', ()=>
    {
        if(!opts.project)
            return;
...
riot.tag2('dashboard-social-purchase', '<div id="purchase-social" class="modal container fade"> <div class="krowdspace-modal col-lg-offset-2 col-md-8"> <div id="modal"> <div class="modal-body modal-purchase no-gutter"> <div class="col-sm-7 purchase-container-left"> <p class="modal-heading">SOCIAL MEDIA POSTS</p> <p class="modal-purchase-text text-left">Your project will be listed on our Explore Page with a featured project icon. Having your project featured means it will get priority filtering and have increased viewership. For a limited time we are offering this as a free service while we work through our initial launch! Please click the Upgrade button below to add this feature.</p> </div> <div class="col-sm-5 purchase-container-right"> <img class="img-responsive" src="/img/content/social-purchase.jpg"> <div class="purchase-price-box no-gutter"> <div class="col-sm-6 text-center divider-inside-right"> <p class="purchase-text">SOCIAL POSTS</p> </div> <div class="col-sm-6 text-center"> <p class="purchase-text-right">FREE</p> </div> <div class="clearfix"></div> </div> <div> <form id="purchaseFeature" role="form" onsubmit="{submitSocial}"> <div class="text-center"> <input class="landing-submit alt-border" style="border-bottom: none;" type="submit" name="submit" value="Upgrade" class="btn-register"> </div> </form> </div> </div> </div> </div> </div> </div>', '', '', function(opts) {
   this.on('update', ()=>
    {
        if(!opts.project)
            return;
...
riot.tag2('project-button', '<div class="filterdark" style="padding: 10px 5px; text-transform: uppercase; font-size: 13px; color: #3f434f; background: #fff;"> <yield></yield> </div>', '', '', function(opts) {
...
riot.tag2('register-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container dashboard"> <global-logout show="{logged_in}" uri="{opts.uri}"></global-logout> <div class="col-sm-10 col-sm-offset-1" style="padding: 0px;"> <div class="row dash-row no-gutter"> <register-content-signup></register-content-signup> </div> </div> </div> <register-project-error></register-project-error> <global-footer></global-footer>', '', '', function(opts) {
});
...
riot.tag2('explore-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> <explore-slider-hero></explore-slider-hero> </div> <div class="container" style="margin-bottom: 50px;"> <explore-content-filter filtersearch="{filter}"></explore-content-filter> <explore-content-card ref="filter"></explore-content-card> </div> <div class="row"> <global-footer></global-footer> </div> <explore-modal-login></explore-modal-login> <explore-modal-register></explore-modal-register>', '', '', function(opts) {
        this.on('mount', ()=>
        {
...
riot.tag2('explore-slider-hero', '<div class="autoplay slider explore-header"> <div class="explore-banner-box" each="{ExploreBannerFilter}"> <img riot-src="{project_data.web_data.mainImg.content}" alt="{project_data.web_data.description.content}"> <div class="explore-box"> <div class="col-sm-9"> <div style="position: relative; height: 301px;"> <div class="explore-feature-left"> <div> <span class="explore-title">{name}</span> </div> <div class="explore-box-text"> <span class="explore-title">{project_data.info_data.reward}</span> </div> </div> </div> </div> <div class="col-sm-3 explore-feature-right text-center"> <a href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><p class="learn-more">Learn More</p></a> </div> </div> </div> </div>', 'explore-slider-hero .slider,[data-is="explore-slider-hero"] .slider{ width: 100%; position: relative; margin: 0px auto; } explore-slider-hero .slick-slide,[data-is="explore-slider-hero"] .slick-slide{ margin: 0px; } explore-slider-hero .slick-slide span,[data-is="explore-slider-hero"] .slick-slide span,explore-slider-hero .slick-slide .learn-more,[data-is="explore-slider-hero"] .slick-slide .learn-more{ display: none; } explore-slider-hero .slick-current span,[data-is="explore-slider-hero"] .slick-current span,explore-slider-hero .slick-current .learn-more,[data-is="explore-slider-hero"] .slick-current .learn-more{ display: inline; } explore-slider-hero .slick-slide img,[data-is="explore-slider-hero"] .slick-slide img{ border-top: 1px solid #dcdedd; border-bottom: 1px solid #dcdedd; width: 550px; } explore-slider-hero .slick-prev:before,[data-is="explore-slider-hero"] .slick-prev:before,explore-slider-hero .slick-next:before,[data-is="explore-slider-hero"] .slick-next:before{ color: black; }', '', function(opts) {
        krowdspace.projects.explore().then((res) =>
        {
            let ExploreBannerData = res.data,
                FilterExplore = ExploreBannerData.filter((element) => {
...
riot.tag2('project-modal-reward', '<div id="kickstarter-reward" class="modal container fade"> <div class="krowdspace-modal col-lg-offset-3 col-md-6"> <div id="modal"> <div class="modal-body"> <div class="col-sm-12 edit-user-box"> <p class="modal-heading">Support Project</p> <p class="registration-text text-left" style="margin-top: 15px;">To support this project and receive the posted reward make sure to send the below COUPON CODE after completing your pledge. All project owners have agreed to fulfill any and all rewards posted on their project page.</p> <div class="couponcode-box text-center"> <p class="couponcode">{couponCode}</p> </div> </div> <div class="clearfix"></div> <div class="text-center"> <a href="{projectLink}" target="_blank"> <p class="landing-submit alt-border" style="border-bottom: none;">SUPPORT PROJECT</p> </a> </div> </div> </div> </div> </div>', '', '', function(opts) {
...
riot.tag2('global-modal-feature', '<div id="modal-feature-info" class="modal container fade"> <div class="krowdspace-modal col-sm-10 col-sm-offset-1"> <div id="modal" class="modal-content"> <div class="modal-header"> <p class="modal-heading">FEATURED PROJECTS AND BOOSTS</p> <p class="legal-text">Welcome to our featured project options for your live crowdfunding project. At Krowdspace we have experienced first-hand how difficult it can be to launch a crowdfunding campaign. For a limited time, we are offering free featured project packages and social media posts! If you would like to take advantage of this special offer please <a onclick="{registerFeatured}" href="/#/account/register" class="modal-link home-links">submit your project</a> to Krowdspace and activate these packages on your <a onclick="{dashboardFeatured}" href="/#/account/dashboard" class="modal-link home-links">Krowdspace Dashboard</a>.</p> </div> <div class="modal-body"> <div class="row"> <div class="col-sm-8 featured-text-box"> <p class="featured-title">FEATURED PROJECT LISTING</p> <p class="legal-text">Every featured project will have a yellow heart icon located in the corner of your project image. These icons will be displayed on our Explore Page filtering system. Having the icon will allow your project to have priority filtering and will always show ahead of other projects without the icon. Our featured project listing will last the entire length of your campaign.</p> </div> <div class="col-sm-4 featured-image-box"> <img class="img-responsive" src="/img/content/featured-purchase.jpg"> </div> </div> <div class="row"> <div class="col-sm-8 featured-text-box"> <p class="featured-title">EXPLORE PAGE BANNER</p> <p class="legal-text">Every project that is featured on our Explore Page Rotating Banner will have increased viewership and a higher click through rate compared to only having the featured icon. Your project will be displayed on our rotating banner located on the Explore Page as a hero image. This explore featured banner will last 7 days and then expire. </p> </div> <div class="col-sm-4 featured-image-box"> <img class="img-responsive" src="/img/content/explore-purchase.jpg"> </div> </div> <div class="row"> <div class="col-sm-8 featured-text-box"> <p class="featured-title">LANDING PAGE BANNER</p> <p class="legal-text">Our Landing Page package will bring the most traffic to your campaign. Every project owner that purchases this package will be featured on the Krowdspace Landing Page rotating banner as well as every Krowdspace users dashboard rotating banner. Your campaign will be seen by everyone! The landing page package will last for 7 days and then expire.</p> </div> <div class="col-sm-4 featured-image-box"> <img class="img-responsive" src="/img/content/landing-purchase.jpg"> </div> </div> <div class="row"> <div class="col-sm-8 featured-text-box"> <p class="featured-title">SOCIAL MEDIA POSTS</p> <p class="legal-text">We will post your project on our 4 social media channels. By purchasing this package, you will see your project on our Facebook, Twitter, Pinterest and Instagram accounts with a link to your crowdfunding site when applicable. We currently have over 6,000 combined followers!</p> </div> <div class="col-sm-4 featured-image-box"> <img class="img-responsive" src="/img/content/social-purchase.jpg"> </div> </div> </div> </div> </div> </div>', '', '', function(opts) {
...
riot.tag2('global-modal-giveaway', '<div id="modal-giveaway" class="modal container fade"> <div class="krowdspace-modal col-sm-6 col-sm-offset-3" style="margin-bottom: 0px;"> <div id="modal" class="modal-content text-center"> <div> <iframe style="width: 100%; height: 1150px; overflow: hidden;" src="https://gleam.io/XsDXo/krowdspace-party-pack-giveaway" frameborder="0" allowfullscreen></iframe> <p class="modal-heading">Previous Giveaway Winners</p> <div class="text-left" style="padding: 30px;"> <p class="privacy-title"><strong>$50 Amazon Card - 04/01/17</strong></p> <p class="privacy-title"><strong>$75 K POP Prize Package - 05/25/17</strong></p> <p class="privacy-title"><strong>$60 Krowdspace Party Pack - 08/22/17</strong></p> </div> </div> </div> </div> </div>', '', '', function(opts) {
});
