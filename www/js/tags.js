riot.tag2('admin-form-confirm', '<div id="admin-update-confirm" class="modal container fade"> <div class="krowdspace-modal-custom padding-reset col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8"> <div id="modal"> <div class="modal-box modal-max-box text-left " style="padding-bottom: 50px;"> <p class="modal-heading">Krowdspace Projects Updated</p> <p class="edit-text-title">Projects have been updated and will instantly reflect the changes to Krowdspace after hitting the close button.</p> </div> <div class="text-center modal-max-box"> <input class="landing-submit" onclick="{refreshPage}" value="Close Modal" style="cursor: pointer;"> </div> </div> </div> </div>', '', '', function(opts) {
this.refreshPage = function()
    {
        window.location.reload();
    }.bind(this)
});
riot.tag2('admin-login', '<div class="dark-modal"> <div class="krowdspace-modal-custom col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8"> <form ref="accountlogin" onsubmit="{adminSubmit}"> <div class="text-left modal-box-alt modal-max-box"> <p class="modal-heading modal-heading-alt">Krowdspace Login</p> <div id="errorLog" class="alert alert-danger alert-dismissable fade in"> <a class="close" onclick="$(\'.alert\').hide()"><i class="fa fa-close"></i></a> <strong>Error:</strong> Invalid username or password. </div> <div class="has-feedback"> <label class="control-label" for="username"></label> <input type="text" class="box-radius form-control" id="username" name="username" placeholder="Username or Email Address" ref="usernameloginAdmin"> <span class="fa fa-user form-control-feedback"></span> </div> <div class="has-feedback"> <label class="control-label" for="password"></label> <input type="password" class="box-radius form-control" id="password" name="password" placeholder="Password" ref="passwordloginAdmin"> <span class="fa fa-lock form-control-feedback"></span> </div> <div class="col-xs-6 login-box text-left"> <label> <input class="check-box" class="check-box" type="checkbox" ref="checkboxAdmin" id="checkbox">Remember Me </label> </div> <div class="col-xs-6 login-box text-right"> <a onclick="{registerPassword}"><p class="forgot-pass">Forgot Password?</p></a> </div> <div class="clearfix"></div> </div> <div class="text-center modal-max-box"> <input type="submit" class="landing-submit" name="submit" value="Login"> </div> </form> <div class="text-center"> <p class="login-float-text">Are you in the right place? <a href="/#/explore" class="function-link">Explore Page!</a></p> </div> </div> </div>', '', '', function(opts) {
                this.adminSubmit = function(e)
                {
...
riot.tag2('admin-page', '<global-logout class="hidden-xs" show="{logged_in}" uri="{opts.uri}"></global-logout> <div class="col-sm-12 text-center"> <p> <span class="admin-options"> <i class="fa fa-circle" style="color: #d9534f;" aria-hidden="true"></i> Returned </span> <span class="admin-options"> <i class="fa fa-circle" style="color: #fdb540;" aria-hidden="true"></i> Pending </span> <span class="admin-options"> <i class="fa fa-circle" style="color: #93e026;" aria-hidden="true"></i> Approved </span> <span class="admin-options"> <i class="fa fa-circle" style="color: #000000;" aria-hidden="true"></i> Expired </span> </p> </div> <div class="col-sm-12 text-left admin-container row-verify padding-reset shadow"> <div class="col-sm-12 admin-box no-gutter"> <div class="col-sm-1"> <p class="admin-text">NAME</p> </div> <div class="col-sm-7"> <p class="admin-text">REWARD</p> </div> <div class="col-sm-3 padding-reset"> <div class="col-sm-3 text-center padding-reset"> <p class="admin-text padding-reset">FEATURE</p> </div> <div class="col-sm-3 text-center padding-reset"> <p class="admin-text padding-reset">EXPLORE</p> </div> <div class="col-sm-3 text-center padding-reset"> <p class="admin-text padding-reset">LANDING</p> </div> <div class="col-sm-3 text-center padding-reset"> <p class="admin-text padding-reset">SOCIAL</p> </div> </div> <div class="col-sm-1 text-center"> <p class="admin-text">VALID</p> </div> </div> <div ref="adminForm"> <form class="adminPanel" each="{adminData}"> <div class="col-sm-12 admin-data-box no-gutter"> <div class="col-sm-1"> <input class="admin-text" name="projectId" type="hidden" riot-value="{unique_id}"> <p class="admin-text">{unique_id}</p> </div> <div class="col-sm-7"> <p class="admin-text">{project_data.info_data.reward}</p> </div> <div class="col-sm-3 padding-reset"> <div class="col-sm-3 text-center"> <input name="featuredCheck" checked="{project_data.info_data.featured}" type="checkbox"> </div> <div class="col-sm-3 text-center"> <input name="exploreCheck" checked="{project_data.info_data.explore}" type="checkbox"> </div> <div class="col-sm-3 text-center"> <input name="landingCheck" checked="{project_data.info_data.landing}" type="checkbox"> </div> <div class="col-sm-3 text-center"> <input name="socialCheck" checked="{project_data.info_data.social}" type="checkbox"> </div> </div> <div class="col-sm-1 text-center"> <input class="admin-radio" checked="{project_data.info_data.rewardValid == \'2\'}" name="rewardStatus" type="radio" value="2"> <input class="admin-radio" checked="{project_data.info_data.rewardValid == \'0\'}" name="rewardStatus" type="radio" value="0"> <input class="admin-radio" checked="{project_data.info_data.rewardValid == \'1\'}" name="rewardStatus" type="radio" value="1"> <input class="admin-radio" checked="{project_data.info_data.rewardValid == \'3\'}" name="rewardStatus" type="radio" value="3"> </div> </div> </form> <div class="col-sm-12 padding-reset"> <button type="button" onclick="{adminPanel}" class="admin-comment-submit" name="submit" value="Update Project Database">Update Project Database</button> </div> </div> </div> <div class="col-sm-12 text-left admin-container padding-reset row-verify shadow"> <div class="col-sm-12 admin-box no-gutter"> <div class="col-sm-2"> <p class="admin-text">NAME</p> </div> <div class="col-sm-3"> <p class="admin-text">EMAIL</p> </div> <div class="col-sm-7"> <p class="admin-text">COMMENT</p> </div> </div> <div class="col-sm-12 admin-data-box no-gutter" each="{adminComments}"> <div class="col-sm-2"> <p class="admin-text">{fname}</p> </div> <div class="col-sm-3"> <p class="admin-text">{email}</p> </div> <div class="col-sm-7"> <p class="admin-text">{comment}</p> </div> </div> </div>', 'admin-page input[type="radio"],[data-is="admin-page"] input[type="radio"]{ -webkit-appearance: none; -moz-appearance: none; appearance: none; display: inline-block; width: 13px; height: 13px; background-clip: content-box; border: 2px solid #bbbbbb; background-color: #e7e6e7; border-radius: 50%; } admin-page input[type="radio"]:focus,[data-is="admin-page"] input[type="radio"]:focus{ outline: none; } admin-page input[type="radio"]:checked:nth-of-type(1),[data-is="admin-page"] input[type="radio"]:checked:nth-of-type(1){ background-color: #d9534f; } admin-page input[type="radio"]:checked:nth-of-type(2),[data-is="admin-page"] input[type="radio"]:checked:nth-of-type(2){ background-color: #fdb540; } admin-page input[type="radio"]:checked:nth-of-type(3),[data-is="admin-page"] input[type="radio"]:checked:nth-of-type(3){ background-color: #93e026; } admin-page input[type="radio"]:checked:nth-of-type(4),[data-is="admin-page"] input[type="radio"]:checked:nth-of-type(4){ background-color: #000; }', '', function(opts) {
        let DATA = {
            LIMIT: 50,
        };
...
riot.tag2('dashboard-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <div class="container dashboard"> <div class="shadow text-left project-add-container"> <p class="project-add-text">PROJECTS</p> <div class="project-yield text-center" each="{p, index in projects}"> <project-button onclick="{makeButtF(p)}" project="{p}">{project.unique_id}</project-button> </div> <a href="/#/account/register"> <i class="fa fa-plus project-add-btn filterdark"></i> </a> </div> <dashboard-project-buttons class="hidden-xs" user="{user}" project="{project}"></dashboard-project-buttons> <div class="col-sm-10 col-sm-offset-1 padding-reset"> <div class="row dash-row no-gutter shadow"> <dashboard-project-image show="{project}" project="{project}"></dashboard-project-image> <dashboard-user-image show="{!project}"></dashboard-user-image> <dashboard-project-user show="{project}" index="{projectIndex + 1}" user="{user}" project="{project}"></dashboard-project-user> <dashboard-user show="{!project}" user="{user}"></dashboard-user> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-title project="{project}"> </dashboard-project-title> <dashboard-project-reward project="{project}"></dashboard-project-reward> <dashboard-project-hours project="{project}"></dashboard-project-hours> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-featured project="{project}"> </dashboard-project-featured> </div> <div class="row dash-row no-gutter hidden-xs shadow"> <dashboard-project-bar show="{project}" project="{project}"></dashboard-project-bar> <dashboard-user-bar show="{!project}"></dashboard-user-bar> </div> </div> </div> <dashboard-featured-purchase user="{user}" project="{project}"></dashboard-featured-purchase> <dashboard-explore-purchase user="{user}" project="{project}"></dashboard-explore-purchase> <dashboard-landing-purchase user="{user}" project="{project}"></dashboard-landing-purchase> <dashboard-social-purchase user="{user}" project="{project}"></dashboard-social-purchase> <dashboard-edit-profile user="{user}" project="{project}"></dashboard-edit-profile> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <dashboard-delete-project user="{user}" project="{project}"></dashboard-delete-project> <dashboard-refresh-content user="{user}" project="{project}"></dashboard-refresh-content> <dashboard-image-project user="{user}" project="{project}"></dashboard-image-project> <dashboard-project-status></dashboard-project-status> <global-footer></global-footer>', '@media screen and (max-width: 767px) { dashboard-page .shadow,[data-is="dashboard-page"] .shadow{ -webkit-box-shadow: none; -moz-box-shadow: none; } dashboard-page .project-add-btn,[data-is="dashboard-page"] .project-add-btn{ width: 35px; padding: 7px 5px 9px 5px !important; display: inline-block; font-size: 15px; border: 1px solid #3f434f; border-left: none; } dashboard-page .project-add-btn:hover,[data-is="dashboard-page"] .project-add-btn:hover{ border: 1px solid #3f434f; border-left: none; } }', '', function(opts) {
        this.projectNum = 0;
        this.projectIndex = 0;
        this.projects = [];
...
riot.tag2('dashboard-user-image', '<div class="col-md-6 project-image-responsive padding-reset"> <div class="single-item-dashboard slider"> <div class="landing-banner" each="{ExploreBannerFilter}"> <img class="img-responsive landing-slider {project_data.meta_data.mainImg || \'indiegogo-image-small\'}" riot-src="{project_data.meta_data.mainImg || project_data.meta_data.altImg}" alt="{project_data.meta_data.title}"> <div class="landing-banner-box"> <div class="col-xs-10 padding-reset"> <span class="explore-title">{name}</span> <div class="explore-box-text"> <span class="explore-title">{project_data.info_data.reward}</span> </div> </div> <div class="col-xs-2 learn-more-box text-right"> <a href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><i class="fa fa-plus learn-more-plus"></i></a> </div> </div> </div> </div> </div>', 'dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ width: 500px; height: 282px; background-color: #000; position: relative; } dashboard-user-image .landing-slider,[data-is="dashboard-user-image"] .landing-slider{ border: 1px solid #000; width: 100%; } dashboard-user-image .indiegogo-image-small,[data-is="dashboard-user-image"] .indiegogo-image-small{ height: 282px; width: auto; margin-left: auto; margin-right: auto; } @media screen and (max-width: 1200px) { dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ height: 224px; width: 396px; } dashboard-user-image .indiegogo-image-small,[data-is="dashboard-user-image"] .indiegogo-image-small{ height: 225px; } } @media screen and (max-width: 991px) { dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ height: 347px; width: 616.66px; } dashboard-user-image .indiegogo-image-small,[data-is="dashboard-user-image"] .indiegogo-image-small{ height: 347px; } } @media screen and (max-width: 767px) { dashboard-user-image .project-image-responsive,[data-is="dashboard-user-image"] .project-image-responsive{ width: 400px; margin-left: auto; margin-right: auto; } dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ height: 225px; width: 400px; } dashboard-user-image .indiegogo-image-small,[data-is="dashboard-user-image"] .indiegogo-image-small{ height: 225px; } }', '', function(opts) {
...
riot.tag2('dashboard-user', '<div class="col-md-6 text-left no-gutter project-user-container"> <a href="#edit-profile" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn filterdark float-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-pencil fa-stack-1x fa-inverse"></i> </span> </a> <p class="profile-name capital">{firstname || \'Firstname\'} {lastname || \'Lastname\'}</p> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break">Username:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break capital">{username || \'Username\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user">Email:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user capital">{email || \'Email Address\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break hidden-md">Kickstarter Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break hidden-md capital">{kickstarter || \'N/A\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user hidden-md">Indiegogo Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user hidden-md capital">{indiegogo || \'N/A\'}</p> </div> <div class="user-position-box"> <p class="dashboard-text profile-name">Krowdspace Campaigns</p> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Kickstarter</p> <p class="social-metric">{kickstarterTotal}</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Indiegogo</p> <p class="social-metric">{indiegogoTotal}</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Rewards</p> <p class="social-metric">${krowdspaceTotalReward || 0}</p> </div> </div> <div class="clearfix"></div> </div>', '@media screen and (max-width: 1200px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 224px; } } @media screen and (max-width: 991px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 300px; border-left:1px solid #000; } } @media screen and (max-width: 767px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ width: 400px; margin-left: auto; margin-right: auto; } }', '', function(opts) {
this.on('mount', () => {
...
riot.tag2('giveaway-content', '<div class="row giveaway-flex" style="width: 100%; margin-top: 0px;"> <div id="giveaway-box" class="giveaway-data"> <p class="giveaway-title">Krowdspace Giveaways</p> <p class="giveaway-description">Periodically we will have giveaways from crowdfunding campaigns and/or awesome prizes sponsored by Krowdspace. If you would like to submit your own project for our giveaway program please contact us directly. If your project is selected, Krowdspace will market your campaign for a $50 fee to get the campaign running. All giveaway participants will need to provide a prize worth $50 or more for elegibility.</p> <div class="row" style="margin-left: 0px; margin-right: 0px; margin-top: 50px;"> <div class="col-sm-6 giveaway-box" style="padding: 0px;"> <img id="giveaway8" class="giveaway img-responsive"> </div> <div class="col-sm-6 giveaway-sm"> <p>T01 Tactical Wallet + Tether + Extra Band Bundle Giveaway</p> <p>Enter to win a T01 Tactical Wallet + Tether + Extra Band worth over $110 and help introduce the brand new P01 Pioneer Bifold Wallet &amp; Pen from Dango. Take a moment to admire these handcrafted Italian leather products made in the USA. Now funding on Kickstarter and being featured at Krowdspace.</p> <div class="giveaway-btn-box"> <a href="https://gleam.io/BbZCF/t01-tactical-wallet-bundle-giveaway" target="_blank"> <button class="btn back-project" style="padding: 8px 20px;">ENTER GIVEAWAY</button> </a> </div> </div> </div> <div class="row" style="margin-left: 0px; margin-right: 0px; margin-top: 50px;"> <div class="col-sm-6 giveaway-box"> <p>The P01 Pioneer Bifold Wallet &amp; Pen Kickstarter Giveaway!</p> <p>Enter to win a Handcrafted D01 Dapper Wallet Worth $70 and help introduce the brand new P01 Pioneer Bifold Wallet &amp; Pen from Dango. Take a moment to admire these handcrafted Italian leather products made in the USA. Now funding on Kickstarter and being featured at Krowdspace.</p> <div class="giveaway-btn-box"> <a href="https://gleam.io/sMyBN/pioneer-bifold-wallet-pen" target="_blank"> <button class="btn back-project" style="padding: 8px 20px;">ENTER GIVEAWAY</button> </a> </div> </div> <div class="col-sm-6"> <img id="giveaway7" class="giveaway img-responsive"> </div> </div> </div> </div> </div> <div class="row profile-body-flex" style="width: 100%;"> <div class="article-flex-reverse"> <div class="profile-image-inner"> <div class="item"> <img id="giveaway6" class="img-slider profile-article-image img-responsive"> </div> </div> <div class="profile-article-box-reverse"> <p class="profile-article-title">Second Chance to Win a GP 1945 Bolt Action Plus Pen Now on Kickstarter!</p> <p>Second Chance Giveaway to win a GP 1945 Bolt Action Plus Pen with an estimated value of $50! This pen is the world\'s first bolt action pen with multi-tone PRO whistle &amp; survival breaker. Take a look at this amazing product now crowdfunding on Kickstarter and being featured at Krowdspace.</p> <p>Winner Picked on 10/24/17 - Congratulations Cynthia A.</p> </div> </div> <div class="article-box-flex"> <div class="profile-image-inner"> <div class="item"> <img id="giveaway5" class="img-slider profile-article-image img-responsive"> </div> </div> <div class="profile-article-box"> <p class="profile-article-title">GP 1945 Bolt Action Plus Pen Giveaway. Now Live on Kickstarter!</p> <p>Enter for your chance to win a GP 1945 Bolt Action Plus Pen with an estimated value of $50! This pen is the world\'s first bolt action pen with multi-tone PRO whistle &amp; survival breaker. Take a look at this amazing product now crowdfunding on Kickstarter and being featured at Krowdspace.</p> <p>Winner Picked on 10/17/17 - Congratulations Janice M.</p> </div> </div> <div class="article-flex-reverse"> <div class="profile-image-inner"> <div class="item"> <img id="giveaway4" class="img-slider profile-article-image img-responsive"> </div> </div> <div class="profile-article-box-reverse"> <p class="profile-article-title">$75 Amazon Gift Card - Krowdspace Official Launch Giveaway</p> <p>Welcome to our Krowdspace Launch Giveaway. To celebrate, we are giving away a $75 Amazon Gift Card to spend on anything you want! Follow us on social media for updates and more chances to win!</p> <p>Winner Picked on 08/22/17 - Congratulations Roy V.</p> </div> </div> <div class="article-box-flex"> <div class="profile-image-inner"> <div class="item"> <img id="giveaway3" class="img-slider profile-article-image img-responsive"> </div> </div> <div class="profile-article-box"> <p class="profile-article-title">Krowdspace Game Pack Giveaway</p> <p>Welcome to our Krowdspace Game Pack Giveaway. You could win an Exploding Kittens card game, Fidget Spinner and Fidget Cube with an estimated value of over $60! Follow us on social media for updates and more chances to win!</p> <p>Winner Picked on 06/20/17 - Congratulations Susan E.</p> </div> </div> <div class="article-flex-reverse"> <div class="profile-image-inner"> <div class="item"> <img id="giveaway2" class="img-slider profile-article-image img-responsive"> </div> </div> <div class="profile-article-box-reverse"> <p class="profile-article-title">K POP Foods Sauce Package Giveaway</p> <p>K POP Foods has launched their sauce on Kickstarter and we are giving away 6 bottles, a bottle opener, K POP decals and a custom t-shirt to celebrate! Their amazing sauce goes great on everything and we want to share it with you! Check out their project on Kickstarter or follow them on social media for updates!</p> <p>Winner Picked on 05/01/17 - Congratulations Shay O.</p> </div> </div> <div class="article-box-flex"> <div class="profile-image-inner"> <div class="item"> <img id="giveaway1" class="img-slider profile-article-image img-responsive"> </div> </div> <div class="profile-article-box"> <p class="profile-article-title">Krowdspace Launch $50 Amazon Gift Card</p> <p>We have launched Krowdspace and to celebrate we are giving away a $50 Amazon Gift Card. Krowdspace will be releasing a dashboard that creates a unified platform for crowdfunding project. Check us out on social media or Krowdspace.com for updates!</p> <p>Winner Picked on 03/21/17 - Congratulations Pamela G.</p> </div> </div> </div>', 'giveaway-content .profile-body-flex,[data-is="giveaway-content"] .profile-body-flex{ display: flex; flex-direction: column; padding: 0px 15px; margin-top: 50px; margin-bottom: 25px; } giveaway-content .article-box-flex,[data-is="giveaway-content"] .article-box-flex{ display: flex; justify-content: center; padding: 0px 15px; margin-bottom: 50px; } giveaway-content .article-flex-reverse,[data-is="giveaway-content"] .article-flex-reverse{ display: flex; justify-content: center; padding: 0px 15px; margin-bottom: 50px; flex-direction: row-reverse; } giveaway-content .profile-article-image,[data-is="giveaway-content"] .profile-article-image{ background-color: #d5d5d5; height: 100% !important; width: 100%; margin-left: auto; margin-right: auto; } giveaway-content .profile-image-inner,[data-is="giveaway-content"] .profile-image-inner{ width: 40%; } giveaway-content .profile-article-box,[data-is="giveaway-content"] .profile-article-box,giveaway-content .profile-article-box-reverse,[data-is="giveaway-content"] .profile-article-box-reverse{ width: 60%; margin: 0px 15px 0px 15px; } giveaway-content #giveaway1,[data-is="giveaway-content"] #giveaway1{ content: url(\'../img/giveaway-01.png\'); border: 1px solid #d5d5d5; } giveaway-content #giveaway2,[data-is="giveaway-content"] #giveaway2{ content: url(\'../img/giveaway-02.jpg\'); border: 1px solid #d5d5d5; } giveaway-content #giveaway3,[data-is="giveaway-content"] #giveaway3{ content: url(\'../img/giveaway-03.jpg\'); border: 1px solid #d5d5d5; } giveaway-content #giveaway4,[data-is="giveaway-content"] #giveaway4{ content: url(\'../img/giveaway-04.jpg\'); border: 1px solid #d5d5d5; } giveaway-content #giveaway5,[data-is="giveaway-content"] #giveaway5{ content: url(\'../img/giveaway-05.jpg\'); border: 1px solid #d5d5d5; } giveaway-content #giveaway6,[data-is="giveaway-content"] #giveaway6{ content: url(\'../img/giveaway-06.jpg\'); border: 1px solid #d5d5d5; } giveaway-content #giveaway7,[data-is="giveaway-content"] #giveaway7{ content: url(\'../img/giveaway-07.jpg\'); border: 1px solid #d5d5d5; } giveaway-content #giveaway8,[data-is="giveaway-content"] #giveaway8{ content: url(\'../img/giveaway-08.jpg\'); border: 1px solid #d5d5d5; } giveaway-content .giveaway-flex,[data-is="giveaway-content"] .giveaway-flex{ display: flex; flex-direction: row; padding: 0px 15px; margin-top: 50px; } giveaway-content #giveaway-box,[data-is="giveaway-content"] #giveaway-box{ padding-left: 15px; padding-right: 15px; } giveaway-content .giveaway-data,[data-is="giveaway-content"] .giveaway-data{ padding-bottom: 25px; border-bottom: 1px solid #d5d5d5; } giveaway-content #giveaway-box>giveaway-live>.giveaway-box,[data-is="giveaway-content"] #giveaway-box>giveaway-live>.giveaway-box{ padding-left: 0px; } giveaway-content .giveaway-btn-box,[data-is="giveaway-content"] .giveaway-btn-box{ margin-top: 25px; padding-left: 5px; padding-right: 5px; } giveaway-content .giveaway-title,[data-is="giveaway-content"] .giveaway-title{ font-size: 16px; padding: 0px; } giveaway-content .giveaway-description,[data-is="giveaway-content"] .giveaway-description{ margin-bottom: 25px; padding: 0px; } @media (max-width: 894px) { giveaway-content .article-box-flex,[data-is="giveaway-content"] .article-box-flex,giveaway-content .article-flex-reverse,[data-is="giveaway-content"] .article-flex-reverse{ flex-direction: column; } giveaway-content .profile-image-inner,[data-is="giveaway-content"] .profile-image-inner{ width: 100%; } giveaway-content .profile-article-box,[data-is="giveaway-content"] .profile-article-box,giveaway-content .profile-article-box-reverse,[data-is="giveaway-content"] .profile-article-box-reverse,giveaway-content .giveaway-sm,[data-is="giveaway-content"] .giveaway-sm{ padding-top: 25px; width: 100%; } } ;', '', function(opts) {
});

riot.tag2('giveaway-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container dashboard"> <global-logout class="hidden-xs" show="{logged_in}" uri="{opts.uri}"></global-logout> <div class="col-sm-12 padding-reset"> <div class="row dash-row no-gutter"> <giveaway-content></giveaway-content> </div> </div> </div> <global-footer></global-footer>', '', '', function(opts) {
    $(document).ready(function () {
          $(window).scrollTop(0);
        });
});

riot.tag2('giveaway', '<giveaway-page></giveaway-page>', '', '', function(opts) {
});

riot.tag2('login-account', '<div class="row-verify"> <div class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8"> <form ref="accountlogin" onsubmit="{loginSubmit}" autocomplete="on"> <div class="text-left modal-box-alt modal-max-box"> <p class="modal-heading modal-heading-alt">Krowdspace Login</p> <div id="errorLog" class="alert alert-danger alert-dismissable fade in"> <a class="close" onclick="$(\'.alert\').hide()"><i class="fa fa-close"></i></a> <strong>Error:</strong> Invalid username or password. </div> <div class="has-feedback"> <label class="control-label" for="username"></label> <input type="text" class="box-radius form-control" id="username" name="username" placeholder="Username or Email Address" ref="usernamelogin"> <span class="fa fa-user form-control-feedback"></span> </div> <div class="has-feedback"> <label class="control-label" for="password"></label> <input type="password" class="box-radius form-control" id="password" name="password" placeholder="Password" ref="passwordlogin"> <span class="fa fa-lock form-control-feedback"></span> </div> <div class="col-xs-6 login-box text-left"> <label> <input class="check-box" class="check-box" type="checkbox" ref="checkbox" id="checkbox">Remember Me </label> </div> <div class="col-xs-6 login-box text-right"> <a onclick="{registerPassword}"><p class="forgot-pass">Forgot Password?</p></a> </div> <div class="clearfix"></div> </div> <div class="text-center modal-max-box"> <input type="submit" class="landing-submit" name="submit" value="Login"> </div> </form> <div class="text-center"> <p class="login-float-text">Dont have an account? <a class="function-link" onclick="{registerModal}">Register today!</a></p> </div> </div> </div>', '', '', function(opts) {
...
riot.tag2('login-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container-stand-alone"> <div class="col-sm-10 col-sm-offset-1 padding-reset"> <div class="row dash-row no-gutter"> <login-account></login-account> </div> </div> </div>', '', '', function(opts) {
});
...
riot.tag2('register-content-signup', '<div class="no-gutter register-background shadow"> <div class="col-lg-5 hidden-md hidden-sm hidden-xs register"> <img class="img-responsive" src="/img/content/krowdspace-register.png"> <p class="text-center register-cta">Register your crowdfunding campaign and accelerate your growth today!</p> </div> <div class="col-lg-7 col-md-12"> <div class="registration-box shadow"> <div class="project-select-page"> <p class="register-title">Start by choosing your platform</p> <div class="col-xs-push-1 col-xs-6 indiegogo-register text-center"> <a class="indiegogo-register" type="button" onclick="{indiegogoForm}"><img class="img-responsive register-icons" src="img/fav/indiegogo-icon.svg"></a> <p class="landing-text">Indiegogo</p> </div> <div class="col-xs-pull-1 col-xs-6 kickstarter-register text-center"> <a class="kickstarter-register" type="button" onclick="{kickstarterForm}"><img class="img-responsive register-icons" src="img/fav/kickstarter-icon.svg"></a> <p class="landing-text">Kickstarter</p> </div> </div> <register-kickstarter-form></register-kickstarter-form> <register-indiegogo-form></register-indiegogo-form> </div> </div> <div class="clearfix"></div> </div> <div class="col-sm-12 text-center"> <p class="register-rewards">For more information about Krowdspace Rewards please view our <a href="#modal-global-rewards" data-toggle="modal" class="home-links">Reward Page</a>.</p> </div>', '@media screen and (max-width: 560px) { register-content-signup .shadow,[data-is="register-content-signup"] .shadow{ -webkit-box-shadow: none; -moz-box-shadow: none; } register-content-signup .register-background,[data-is="register-content-signup"] .register-background{ border: none; } }', '', function(opts) {
...
riot.tag2('register-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container dashboard"> <global-logout class="hidden-sm hidden-xs" show="{logged_in}" uri="{opts.uri}"></global-logout> <div class="col-sm-10 col-sm-offset-1 padding-reset"> <div class="row dash-row no-gutter"> <register-content-signup></register-content-signup> </div> </div> </div> <register-project-perk></register-project-perk> <register-project-link></register-project-link> <register-project-id></register-project-id> <register-project-error></register-project-error> <global-footer></global-footer>', '', '', function(opts) {
});
...
riot.tag2('reset-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container-stand-alone"> <div class="col-sm-10 col-sm-offset-1 padding-reset"> <div class="row dash-row no-gutter"> <reset-password></reset-password> </div> </div> </div>', '', '', function(opts) {
});
...
riot.tag2('explore-slider-hero', '<div class="home-banner"> <div class="autoplay-explore slider explore-header"> <div class="landing-banner" each="{ExploreBannerFilter}"> <img class="landing-slider img-responsive {project_data.meta_data.mainImg || \'indiegogo-image-small\'}" riot-src="{project_data.meta_data.mainImg || project_data.meta_data.altImg}" alt="{project_data.meta_data.title}"> <div class="landing-banner-box"> <div class="col-xs-9 padding-reset"> <span class="explore-title">{project_data.meta_data.title}</span> <div class="explore-box-text"> <span class="explore-title">{project_data.info_data.reward}</span> </div> </div> <div class="col-xs-3 learn-more-box text-right"> <a class="plus-switch-one" href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><p class="learn-more">Learn More</p></a> <a class="plus-switch" href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><i class="fa fa-plus learn-more-plus"></i></a> </div> </div> </div> </div> </div>', 'explore-slider-hero .landing-banner,[data-is="explore-slider-hero"] .landing-banner{ height:310px; overflow: hidden; width: 550px; background-color: #000; position: relative; border-top:1px solid #000; border-bottom:1px solid #000; } explore-slider-hero .landing-slider,[data-is="explore-slider-hero"] .landing-slider{ height: auto; margin-left: auto; margin-right: auto; } explore-slider-hero .indiegogo-image-small,[data-is="explore-slider-hero"] .indiegogo-image-small{ height:310px; width: auto; } @media screen and (max-width: 550px) { explore-slider-hero .col-xs-9,[data-is="explore-slider-hero"] .col-xs-9{ width: 90%; } explore-slider-hero .col-xs-3,[data-is="explore-slider-hero"] .col-xs-3{ width: 10%; } explore-slider-hero .landing-banner,[data-is="explore-slider-hero"] .landing-banner{ height:225px; } explore-slider-hero .indiegogo-image-small,[data-is="explore-slider-hero"] .indiegogo-image-small{ height:225px; width: auto; } explore-slider-hero .landing-banner,[data-is="explore-slider-hero"] .landing-banner{ width: 400px; background-color: #000; position: relative; } explore-slider-hero .home-banner,[data-is="explore-slider-hero"] .home-banner{ width: 100%; margin-right: 0px; margin-left: 0px; min-width: 400px; } }', '', function(opts) {
    let DATA = {
            LIMIT: 50,
        };
...
riot.tag2('project-page-image', '<div class="col-md-6 project-image-box padding-reset"> <img class="img-responsive project-image {indiegogoSmall || \'project-image-indiegogo\'}" ref="krowdspaceImage" src="" alt="{krowdspaceAlt}"> <p class="funding-text funded-left">$ {raisedLocale || 0} RAISED</p> <p class="funding-text funded-right">$ {goalLocale || 0} GOAL</p> <div id="progressBar"></div> </div>', '', '', function(opts) {
    krowdspace.projects.project(this.opts.uri).then((res)=>
    {
        ...
        this.goalLocale = Math.round(parseFloat(res.data[0].project_data.meta_data.funding.toLocaleString().replace(/,/g, ''))).toLocaleString() || 0;
...
riot.tag2('project-page-title', '<div class="col-md-6 text-left no-gutter project-page-container"> <p class="project-text">{projectTitle}</p> <p class="project-text">{projectDescription}</p> <p class="project-text">Reward: {projectReward}</p> <p class="project-text hidden-md">To view the coupon code or directly link to the rewards page please click on the "Back Project" button below.</p> <div class="reward-position-box"> <div class="col-xs-6 text-center divider-inside-right backed-box"> <a show="{projectbtn}" href="#kickstarter-reward" class="modal-link" data-toggle="modal"> <p class="back-project">BACK PROJECT</p> </a> <a show="{!projectbtn}" href="{projectLink}" target="_blank"> <p class="back-project">BACK PROJECT</p> </a> </div> <div class="col-xs-6 text-center backed-box-right"> <p class="social-metric">{counterProject} DAYS LEFT</p> </div> </div> </div>', '', '', function(opts) {
        krowdspace.projects.project(this.opts.uri).then((res)=>
        {
...
riot.tag2('global-modal-feature', '<div id="modal-feature-info" class="modal container padding-reset fade"> <div class="krowdspace-modal col-sm-10 col-sm-offset-1"> <div id="modal" class="modal-content"> <div class="modal-header"> <button type="button" class="close btn-modal" data-dismiss="modal" aria-hidden="true"> <i class="fa fa-2x fa-times krowdspace" aria-hidden="true"></i> </button> <p class="modal-heading">FEATURED PROJECTS AND BOOSTS</p> <p class="legal-text">Welcome to our featured project options for your live crowdfunding project. For a limited time, we are offering free featured project packages and social media posts! If you would like to take advantage of this special offer please <a onclick="{registerFeatured}" href="/#/account/register" class="home-links">submit your project</a> to Krowdspace and activate these packages on your <a onclick="{dashboardFeatured}" href="/#/account/dashboard" class="home-links">Krowdspace Dashboard</a>.</p> </div> <div class="modal-body"> <div> <div class="col-md-8 featured-text-box"> <p class="featured-title">FEATURED PROJECT LISTING</p> <p class="legal-text">Every featured project will have a yellow heart icon located in the corner of your project image. These icons will be displayed on the Explore Page filtering system. Having the icon will allow your project to have priority filtering and will always show ahead of other projects without the icon. The featured project listing will last the entire length of your campaign.</p> </div> <div class="col-md-4 hidden-sm hidden-xs featured-image-box"> <img class="img-responsive featured-img" alt="Featured Purchase" src="/img/content/featured-purchase.jpg"> </div> </div> <div> <div class="col-md-8 featured-text-box"> <p class="featured-title">EXPLORE PAGE BANNER</p> <p class="legal-text">Every project that is featured on the Explore Page Rotating Banner will have increased viewership and a higher click through rate compared to only having the featured icon. Your project will be displayed on our rotating banner located on the Explore Page as a hero image. This explore featured banner will last 7 days and then expire. </p> </div> <div class="col-md-4 hidden-sm hidden-xs featured-image-box"> <img class="img-responsive featured-img" alt="Explore Purchase" src="/img/content/explore-purchase.jpg"> </div> </div> <div> <div class="col-md-8 featured-text-box"> <p class="featured-title">LANDING PAGE BANNER</p> <p class="legal-text">The Landing Page package will bring the most traffic to your campaign. Every project owner that purchases this package will be featured on the Krowdspace Landing Page rotating banner as well as every Krowdspace users dashboard rotating banner. Your campaign will be seen by everyone! The landing page package will last for 10 days and then expire.</p> </div> <div class="col-sm-4 hidden-sm hidden-xs featured-image-box"> <img class="img-responsive featured-img" alt="Landing Purchase" src="/img/content/landing-purchase.jpg"> </div> </div> <div> <div class="col-md-8 featured-text-box"> <p class="featured-title">SOCIAL MEDIA POSTS</p> <p class="legal-text">We will post your project on our 4 social media channels. By purchasing this package, you will see your project on our Facebook, Twitter, Pinterest and Instagram accounts with a link to your crowdfunding site when applicable. We currently have over 6,000 combined followers!</p> </div> <div class="col-sm-4 hidden-sm hidden-xs featured-image-box"> <img class="img-responsive featured-img" alt="Social Media Purchase" src="/img/content/social-purchase.jpg"> </div> </div> </div> <div class="clearfix"></div> <div class="modal-close-box text-right"> <button type="button" class="modal-close" data-dismiss="modal">Close</button> </div> </div> </div> </div>', '', '', function(opts) {
