...
riot.tag2('boosts', '<boosts-page></boosts-page>', 'boosts,[data-is="boosts"]{ background-color: #fff }', '', function(opts) {
...
riot.tag2('profile-page', '<div class="row"> <account-navigation></account-navigation> </div> <div class="container-alt"> <div class="row"> <profile-content-information></profile-content-information> </div> </div> <global-footer></global-footer>', '', '', function(opts) {
});
riot.tag2('profile', '<profile-page show="{logged_in}"></profile-page>', 'profile,[data-is="profile"]{ background-color: #fff }', '', function(opts) {
...
riot.tag2('project-page', '<div class="row"> <explore-navigation></explore-navigation> </div> <div class="container"> <project-content-header></project-content-header> <div class="row dash-row-bottom" style="margin-top: 15px"> <project-content-body></project-content-body> </div> </div> <global-footer></global-footer>', '', '', function(opts) {
});
...
riot.tag2('home-navigation', '<nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top"> <div class="container"> <div class="navbar-header page-scroll"> <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-collapse"> <span class="sr-only">Toggle navigation</span><i class="fa fa-bars"></i> </button> <a class="page-scroll" href="#page-top"><img class="navbar-logo" src="img/krowdspace-explore.png" style="width:55px;"></a> </div> <div class="collapse navbar-collapse" id="navigation-collapse"> <ul class="nav navbar-nav navbar-right"> <li class="hidden"> <a href="#page-top"></a> </li> <li> <a class="page-scroll" href="/#explore">Explore</a> </li> <li> <a show="{!logged_in}" href="#modal-login" class="modal-link" data-toggle="modal">Submit Project</a> </li> <li> <a show="{logged_in}" href="/#account/boosts" class="modal-link" data-toggle="modal">Boost Project</a> </li> <li> <a show="{logged_in}" href="/#account/dashboard">Dashboard</a> </li> <li> <a show="{!logged_in}" class="page-scroll" href="#benefits">Benefits</a> </li> <li> <a show="{!logged_in}" class="page-scroll" href="#boost">Boosts</a> </li> <li> <a show="{!logged_in}" href="#modal-login" class="modal-link" data-toggle="modal">Login</a> </li> <li> <a show="{logged_in}" href="/#account/profile">Profile</a> </li> </ul> </div> </div> </nav>', '', '', function(opts) {
this.on('mount', function()
{
    $('a.page-scroll').bind('click', function(event)
    {
