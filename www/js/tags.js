...
riot.tag2('dashboard-project-wysiwyg', '<div class="col-sm-12 no-gutter wysiwyg-editor"> <form id="rewardUpgrade" role="form" onsubmit="{submitContent}"> <button class="wysiwyg-save filterdark" type="submit" name="submit">Save</button> <textarea class="wysiwyg" ref="crowdContent"></textarea> </form> </div>', '', '', function(opts) {
    this.on('update', ()=>
    {
        if(!opts.project)
        return;
...
riot.tag2('explore-content-filter', '<div class="row"> <div class="col-md-3 hidden-sm hidden-xs filter-rows"> <select class="form-control"> <option value="">Just Launched</option> <option value="">Closing Soon</option> </select> </div> <div class="col-md-3 col-sm-5 col-sm-offset-0 col-xs-12 filter-rows"> <select class="form-control" ref="options" onchange="{onCatChange}"> <option value="*">Featured Projects</option> <option each="{cat in catArr}" riot-value="{cat}">{cat}</option> </select> </div> <div class="col-lg-2 hidden-md"></div> <div class="col-lg-4 col-md-6 col-sm-7 col-sm-offset-0 col-xs-12 filter-rows"> <form role="search"> <div class="input-group"> <input type="text" ref="searchBox" class="form-control" placeholder="Search Projects" onkeyup="{onSearch}"> <div class="input-group-btn"> <div class="btn btn-void"> <i class="fa fa-search fa-lg"></i> </div> </div> </div> </form> </div> </div>', '', '', function(opts) {
...
riot.tag2('project-page-title', '<div class="col-md-6 text-left no-gutter user-container-project"> <p class="dashboard-text-alt project-title">{projectTitle}</p> <p class="dashboard-text-alt project-description">{projectDescription}</p> <p class="dashboard-text-alt project-reward-text">Reward: {projectReward}</p> <p class="dashboard-text-alt hidden-md hidden-sm project-coupon">To view the coupon code or directly link to the rewards page please follow the "Back Project" button below.</p> <div class="reward-position-box"> <div class="col-xs-6 text-center divider-inside-right backed-box"> <a show="{projectbtn}" href="#kickstarter-reward" class="modal-link" data-toggle="modal"> <p class="back-project">BACK PROJECT</p> </a> <a show="{!projectbtn}" href="{projectLink}" target="_blank"> <p class="back-project">BACK PROJECT</p> </a> </div> <div class="col-xs-6 text-center backed-box-right"> <p class="social-metric">{countdown || 0} DAYS LEFT</p> </div> </div> </div>', '', '', function(opts) {
        krowdspace.projects.project(this.opts.uri).then((res)=>
        {
            let platform = res.data[0].platform;
            this.projectReward = res.data[0].project_data.info_data.reward;
...
riot.tag2('home-content-users', '<div id="benefits"> <div class="container"> <div class="row"> <div class="col-sm-12 text-center"> <h2 class="landing-header">Krowdspace Users</h2> </div> <div class="home-bottom col-lg-offset-2 col-lg-8 col-md-12 text-left"> <p class="user-home-box">There are a lot of benefits to <a href="#modal-global-login" class="modal-link home-links" data-toggle="modal">becoming a member</a> at Krowdspace. By registering with us you will be eligible for exclusive rewards after backing your favorite crowdfunding projects that are hosted on Kickstarter or Indiegogo. We always recommend that members login to Krowdspace before backing a project to see if it has been submitted. We also offer crowdfunding related <a href="/#/account/giveaway" data-toggle="modal" class="modal-link home-links">giveaways</a> to our members! They are exclusive to our community and only members can register. At Krowdspace you will learn quickly that <a href="/#/explore" class="modal-link home-links">discovering new projects</a> is easy and its always fun to get extra stuff!</p> <div class="col-xs-4 text-center divider-inside-right"> <p>Projects Submitted</p> <p class="social-metric">15</p> </div> <div class="col-xs-4 text-center divider-inside-right"> <p>Value of Rewards</p> <p class="social-metric">$300</p> </div> <div class="col-xs-4 text-center"> <p>Helped Raise</p> <p class="social-metric">$5,400</p> </div> <div class="clearfix"></div> </div> </div> </div> </div>', '', '', function(opts) {
});
