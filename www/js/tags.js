...
riot.tag2('dashboard-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <div class="container dashboard"> <div class="shadow text-left project-add-container"> <p class="project-add-text">PROJECTS</p> <div class="project-yield text-center" each="{p, index in projects}"> <project-button onclick="{makeButtF(p)}" project="{p}">{project.unique_id}</project-button> </div> <a href="/#/account/register"> <i class="fa fa-plus project-add-btn filterdark"></i> </a> </div> <global-logout class="hidden-xs" show="{logged_in}"></global-logout> <div class="col-sm-10 col-sm-offset-1 project-container"> <div class="row dash-row no-gutter shadow"> <dashboard-project-image show="{project}" project="{project}"></dashboard-project-image> <dashboard-user-image show="{!project}"></dashboard-user-image> <dashboard-project-user show="{project}" index="{projectIndex + 1}" user="{user}" project="{project}"></dashboard-project-user> <dashboard-user-user show="{!project}" user="{user}"></dashboard-user-user> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-title project="{project}"> </dashboard-project-title> <dashboard-project-reward project="{project}"></dashboard-project-reward> <dashboard-project-hours project="{project}"></dashboard-project-hours> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-featured project="{project}"> </dashboard-project-featured> </div> <div class="row dash-row no-gutter shadow"> <dashboard-project-wysiwyg show="{project}" project="{project}"></dashboard-project-wysiwyg> </div> <div class="row dash-row no-gutter shadow"> <dashboard-project-bar show="{project}" project="{project}"></dashboard-project-bar> <dashboard-user-bar show="{!project}"></dashboard-user-bar> </div> </div> </div> <dashboard-featured-purchase user="{user}" project="{project}"></dashboard-featured-purchase> <dashboard-explore-purchase user="{user}" project="{project}"></dashboard-explore-purchase> <dashboard-landing-purchase user="{user}" project="{project}"></dashboard-landing-purchase> <dashboard-social-purchase user="{user}" project="{project}"></dashboard-social-purchase> <dashboard-edit-profile user="{user}" project="{project}"></dashboard-edit-profile> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <dashboard-refresh-content user="{user}" project="{project}"></dashboard-refresh-content> <dashboard-project-status></dashboard-project-status> <global-footer></global-footer>', '@media screen and (max-width: 767px) { dashboard-page .shadow,[data-is="dashboard-page"] .shadow{ -webkit-box-shadow: none; -moz-box-shadow: none; } dashboard-page .project-add-btn,[data-is="dashboard-page"] .project-add-btn{ width: 35px; padding: 7px 5px 9px 5px; display: inline-block; font-size: 15px; border: 1px solid #3f434f; border-left: none; } dashboard-page .project-add-btn:hover,[data-is="dashboard-page"] .project-add-btn:hover{ border: 1px solid #3f434f; border-left: none; } }', '', function(opts) {
        this.projectNum = 0;
        this.projectIndex = 0;
        this.projects = [];
...
riot.tag2('dashboard-project-status', '<div id="project-status" class="modal container fade"> <div class="krowdspace-modal-custom col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8" style="padding: 0px;"> <div id="modal"> <div class="edit-user-box modal-max-login" style="position: relative; padding-bottom: 15px;"> <button type="button" class="close btn-modal" data-dismiss="modal" aria-hidden="true"> <i class="fa fa-2x fa-times text-primary" aria-hidden="true"></i> </button> <img class="project-approval-modal" src="/img/content/project-status-vertical.svg"> <p class="modal-heading">Project Status</p> <p class="modal-purchase-text text-left edit-text-title" style="margin-top: 15px; margin-bottom: 30px;">After submitting your project to Krowdspace you will have one of three status icons displaying on you dashboard.</p> <p class="modal-purchase-text text-left edit-text-title" style="margin-left: 40px; margin-top: 15px;">Your project reward needs to be modified.</p> <p class="modal-purchase-text" style="margin-left: 40px; margin-top: 20px;">Your project is pending reward approval. </p> <p class="modal-purchase-text" style="margin-left: 40px; margin-top: 20px; margin-bottom: 5px;">Your project has been approved. </p> </div> </div> </div> </div>', '', '', function(opts) {
});
riot.tag2('dashboard-refresh-content', '<div id="refresh-content" class="modal container fade"> <div class="krowdspace-modal-custom col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8" style="padding: 0px;"> <div id="modal"> <form id="submitRefresh" role="form" onsubmit="{submitRefresh}"> <div class="edit-user-box modal-max-login" style="position: relative;"> <button type="button" class="close btn-modal" data-dismiss="modal" aria-hidden="true"> <i class="fa fa-2x fa-times text-primary" aria-hidden="true"></i> </button> <p class="modal-heading">Refresh Project Content</p> <p class="modal-purchase-text text-left edit-text-title" style="margin-top: 15px;">To refresh your project content please click the update button below. This will refresh any content changes as well as your project metric data.</p> <p class="modal-purchase-text">Warning: Updating your project after it has completed on Kickstarter or Indiegogo will reset some of our Krowdspace metrics. </p> </div> <div class="text-center modal-max-login"> <input class="landing-submit alt-border" style="border-bottom: none;" type="submit" name="submit" value="Update" class="btn-register"> </div> </form> </div> </div> </div>', '', '', function(opts) {
      this.on('update', ()=>
       {
           if(!opts.project)
               return;
...
riot.tag2('dashboard-project-title', '<div class="col-lg-3 col-md-12 dashboard-title-box shadow" style="margin-left: 0px;"> <a href="#refresh-content" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn filterdark float-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-refresh fa-stack-1x fa-inverse"></i> </span> </a> <p class="dashboard-text-alt" style="padding-right: 35px; height: 57px;">{projectTitle || \'\'}</p> <p class="dashboard-text-alt" style="padding-top: 15px; height: 110px;">{projectDescription || \'\'}</p> <p class="dashboard-text-alt" style="padding-top: 15px">Please click on the refresh icon to update project.</p> </div>', '', '', function(opts) {
    this.on('update', ()=>
    {
        if(!opts.project)
        return;
...
riot.tag2('giveaway-content', '<div class="col-sm-12 text-left resource-background shadow"> <p class="modal-heading">Krowdspace Giveaways</p> <p class="legal-text">Periodically we will have giveaways for live crowdfunding projects and/or awesome prizes sponsored by Krowdspace. These giveaways are exclusive to our Krowdspace members so there is a higher chance of winning! If you would like to submit your own project for our giveaway program please contact us through the form in the footer. If your project is selected, Krowdspace will set aside a small marketing budget and provide paid advertisement free to you. All you will need to provide is the prize which must be $50 or more for elegibility.</p> <iframe style="width: 100%; height: 1150px; overflow: hidden;" src="https://gleam.io/XsDXo/krowdspace-party-pack-giveaway" frameborder="0" allowfullscreen></iframe> <div class="row"> <div class="col-sm-12"> <p class="privacy-title">Previous Giveaways</p> <div class="giveaway-box text-left"> <p class="privacy-title">$50 Amazon Card - 04/01/17</p> <p class="privacy-title">$75 K POP Prize Package - 05/25/17</p> <p class="privacy-title">$60 Krowdspace Party Pack - 08/22/17</p> </div> </div> </div> </div>', '', '', function(opts) {
});
riot.tag2('giveaway-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container dashboard"> <global-logout class="hidden-xs" show="{logged_in}" uri="{opts.uri}"></global-logout> <div class="col-sm-10 col-sm-offset-1 project-container"> <div class="row dash-row no-gutter"> <giveaway-content></giveaway-content> </div> </div> </div> <global-footer></global-footer>', '', '', function(opts) {
});
riot.tag2('giveaway', '<giveaway-page show="{logged_in}"></giveaway-page>', 'giveaway,[data-is="giveaway"]{ background-color: #fff }', '', function(opts) {
...
riot.tag2('register-project-id', '<div id="modal-register-id" class="modal container fade"> <div class="krowdspace-modal-custom col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8" style="padding: 0px;"> <div id="modal"> <div class="edit-user-box" style="padding-bottom: 15px;"> <button type="button" class="close btn-modal" data-dismiss="modal" aria-hidden="true"> <i class="fa fa-2x fa-times text-primary" aria-hidden="true"></i> </button> <p class="modal-heading">Indiegogo Project ID</p> <p class="modal-purchase-text text-left edit-text-title">We will need your project ID which consists of a 7 digit number located on the project url. Please refer to this <a class="home-links" href="https://support.indiegogo.com/hc/en-us/articles/207276657-How-to-Find-Customize-your-Indiegogo-URL" target="_blank">Indiegogo Help Page</a> for exact locations within your account.</p> <p class="modal-purchase-text text-left edit-text-title">Another easy way to retrieve your project ID is to go to your live crowdfunding page and click on the "Share Twitter" button located next to the "Back It" button.</p> <img class="img-responsive" style="margin-top: 20px; margin-bottom: 20px; margin-left: auto; margin-right: auto; width: 350px;" src="/img/content/indiegogo-help-1.jpg"> <p class="modal-purchase-text text-left edit-text-title">Inside the share message there is a project url with the project ID. Take the project ID number and put it into the Krowdspace register form. An example of the project ID number location is below.</p> <img class="img-responsive" style="margin-top: 20px; margin-bottom: 20px; margin-left: auto; margin-right: auto; width: 350px;" src="/img/content/indiegogo-help-2.jpg"> <p class="modal-purchase-text text-left edit-text-title">If you have any questions please contact Krowdspace on social media or through our contact form in the footer.</p> </div> </div> </div> </div>', '', '', function(opts) {
});
...
riot.tag2('verify-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container dashboard"> <global-logout show="{logged_in}" uri="{opts.uri}"></global-logout> <div class="col-sm-10 col-sm-offset-1 project-container"> <div class="row dash-row no-gutter"> <verify-content-confirm></verify-content-confirm> </div> </div> </div> <global-footer></global-footer>', '', '', function(opts) {
});
...
riot.tag2('project-page-title', '<div class="col-md-6 text-left no-gutter user-container-project"> <p class="dashboard-text-alt project-title">{projectTitle}</p> <p class="dashboard-text-alt project-description">{projectDescription}</p> <p class="dashboard-text-alt project-reward-text">Reward: {projectReward}</p> <p class="dashboard-text-alt hidden-md hidden-sm project-coupon">To view the coupon code or directly link to the rewards page please click on the "Back Project" button below.</p> <div class="reward-position-box"> <div class="col-xs-6 text-center divider-inside-right backed-box"> <a show="{projectbtn}" href="#kickstarter-reward" class="modal-link" data-toggle="modal"> <p class="back-project">BACK PROJECT</p> </a> <a show="{!projectbtn}" href="{projectLink}" target="_blank"> <p class="back-project">BACK PROJECT</p> </a> </div> <div class="col-xs-6 text-center backed-box-right"> <p class="social-metric">{countdown || 0} DAYS LEFT</p> </div> </div> </div>', '', '', function(opts) {
        krowdspace.projects.project(this.opts.uri).then((res)=>
        {
            let platform = res.data[0].platform;
            if (platform == 'kickstarter')
