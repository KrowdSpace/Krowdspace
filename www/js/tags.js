...
riot.tag2('dashboard-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <div class="container dashboard"> <div class="shadow text-left project-add-container"> <p class="project-add-text">PROJECTS</p> <div class="project-yield text-center" each="{p, index in projects}"> <project-button onclick="{makeButtF(p)}" project="{p}">{project.unique_id}</project-button> </div> <a href="/#/account/register"> <i class="fa fa-plus project-add-btn filterdark"></i> </a> </div> <global-logout class="hidden-xs" show="{logged_in}"></global-logout> <div class="col-sm-10 col-sm-offset-1 project-container"> <div class="row dash-row no-gutter shadow"> <dashboard-project-image show="{project}" project="{project}"></dashboard-project-image> <dashboard-user-image show="{!project}"></dashboard-user-image> <dashboard-project-user show="{project}" index="{projectIndex + 1}" user="{user}" project="{project}"></dashboard-project-user> <dashboard-user-user show="{!project}" user="{user}"></dashboard-user-user> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-hours project="{project}"></dashboard-project-hours> <dashboard-project-reward project="{project}"></dashboard-project-reward> </div> <div show="{project}" class="row dash-row no-gutter shadow"> <dashboard-project-title project="{project}"> </dashboard-project-title> </div> <div class="row dash-row no-gutter shadow"> <dashboard-project-bar show="{project}" project="{project}"></dashboard-project-bar> <dashboard-user-bar show="{!project}"></dashboard-user-bar> </div> </div> </div> <dashboard-featured-purchase user="{user}" project="{project}"></dashboard-featured-purchase> <dashboard-explore-purchase user="{user}" project="{project}"></dashboard-explore-purchase> <dashboard-landing-purchase user="{user}" project="{project}"></dashboard-landing-purchase> <dashboard-social-purchase user="{user}" project="{project}"></dashboard-social-purchase> <dashboard-edit-profile user="{user}" project="{project}"></dashboard-edit-profile> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <dashboard-refresh-content user="{user}" project="{project}"></dashboard-refresh-content> <global-footer></global-footer>', '@media screen and (max-width: 767px) { dashboard-page .shadow,[data-is="dashboard-page"] .shadow{ -webkit-box-shadow: none; -moz-box-shadow: none; } dashboard-page .project-add-container,[data-is="dashboard-page"] .project-add-container{ top: 80px; left:0; right: 0; position: absolute; display: inline-block; font-size: 0px; width: 400px; margin-left: auto; margin-right: auto; } dashboard-page .project-add-text,[data-is="dashboard-page"] .project-add-text{ display: inline-block; padding: 7px; font-size: 13px; margin-top: 1px; border: 1px solid #3f434f; } dashboard-page .project-yield,[data-is="dashboard-page"] .project-yield{ display: inline-block; font-size: 14px; border: 1px solid #3f434f; border-left: none; border-right: none; } dashboard-page .project-add-btn,[data-is="dashboard-page"] .project-add-btn{ width: 35px; padding: 7px 5px 9px 5px; display: inline-block; font-size: 15px; border: 1px solid #3f434f; } dashboard-page .project-add-btn:hover,[data-is="dashboard-page"] .project-add-btn:hover{ border: 1px solid #3f434f; } }', '', function(opts) {
	this.projectNum = 0;
	this.projectIndex = 0;
	this.projects = [];
...
riot.tag2('dashboard-project-user', '<div class="col-md-6 text-center no-gutter user-container"> <a href="#edit-profile" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn float-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-pencil fa-stack-1x fa-inverse"></i> </span> </a> <p class="dashboard-text profile-name">{firstname} {lastname}</p> <div> <div class="col-xs-4 text-center divider-inside-right user-stat-box"> <p class="dashboard-user">Current Project</p> <p class="social-metric">{opts.index}</p> </div> <div class="col-xs-4 text-center divider-inside-right user-stat-box"> <p class="dashboard-user">Hours Remaining</p> <p class="social-metric">{countdowntimer || 0}</p> </div> <div class="col-xs-4 text-center user-stat-box"> <p class="dashboard-user">Reward Value</p> <p class="social-metric">{rewardAmount || 0}</p> </div> </div> <div class="col-lg-8 col-md-12 text-left"> <div class="col-md-4 col-sm-4 col-xs-4 user-box-left"> <p class="dashboard-user">Username:</p> <p class="dashboard-user">Email:</p> <p class="dashboard-user">Kickstarter:</p> <p class="dashboard-user">Indiegogo:</p> </div> <div class="col-md-8 col-sm-8 col-xs-8 user-box-right"> <p class="dashboard-user">{username}</p> <p class="dashboard-user">{email}</p> <p class="dashboard-user">{kickstarter || \'N/A\'}</p> <p class="dashboard-user">{indiegogo || \'N/A\'}</p> </div> <div class="clearfix"></div> </div> <div class="col-lg-4 hidden-md hidden-sm hidden-xs"> </div> </div>', '@media screen and (max-width: 1200px) { dashboard-project-user .user-container,[data-is="dashboard-project-user"] .user-container{ height: 242px; } } @media screen and (max-width: 991px) { dashboard-project-user .user-container,[data-is="dashboard-project-user"] .user-container{ height: 282px; } } @media screen and (max-width: 767px) { dashboard-project-user .user-container,[data-is="dashboard-project-user"] .user-container{ height: auto; margin-left: auto; margin-right: auto; width: 400px; border-top: none; } }', '', function(opts) {
    this.on('update', ()=>
    {
        if(!opts.user)
            return;
...
riot.tag2('dashboard-user-bar', '<div class="dash-bar col-sm-12 no-gutter"> <div class="col-sm-3 col-xs-4 text-center divider-inside-right"> <a href="{kickstarterPage}" target="_blank"> <img class="icon-share-bar filterdark" src="img/fav/kickstarter-icon.png"> </a> <a href="{indiegogoPage}" target="_blank"> <img class="icon-share-bar filterdark" src="img/fav/indiegogo-icon.png"> </a> <p class="dashboard-text-bar dash-divider hidden-xs">Crowdfunding Links</p> <p class="dashboard-text-bar dash-divider hidden-lg hidden-md hidden-sm">Links</p> </div> <div class="col-sm-6 col-xs-6 text-center divider-inside-right no-gutter"> <div class="col-sm-12"> <a href="{facebookShare}" target="_blank"> <span class="fa-stack fa-lg facebook filterdark"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-facebook fa-stack-1x fa-inverse"></i> </span> </a> <a href="{twitterShare}" target="_blank"> <span class="fa-stack fa-lg twitter filterdark"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-twitter fa-stack-1x fa-inverse"></i> </span> </a> <a class="hidden-md hidden-sm hidden-xs" href="{linkedinShare}" target="_blank"> <span class="fa-stack fa-lg linkedin filterdark"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-linkedin fa-stack-1x fa-inverse"></i> </span> </a> <a href="{redditShare}" target="_blank"> <span class="fa-stack fa-lg reddit filterdark"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-reddit-alien fa-stack-1x fa-inverse"></i> </span> </a> <a class="hidden-md hidden-sm hidden-xs" href="{diggShare}" target="_blank"> <span class="fa-stack fa-lg digg filterdark"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-digg fa-stack-1x fa-inverse"></i> </span> </a> <a class="hidden-sm hidden-xs" href="{stumbleuponShare}" target="_blank"> <span class="fa-stack fa-lg stumbleupon filterdark"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-stumbleupon fa-stack-1x fa-inverse"></i> </span> </a> <p class="dashboard-text-bar dash-divider hidden-xs">Share Krowdspace on Social Media</p> <p class="dashboard-text-bar dash-divider hidden-lg hidden-md hidden-sm">Share on Social Media</p> </div> </div> <div class="col-sm-3 text-center"> <a href="/#/account/giveaway" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-money fa-stack-1x fa-inverse"></i> </span> </a> <p class="dashboard-text-bar dash-divider hidden-xs">Krowdspace Giveaways</p> </div> </div>', '@media screen and (max-width: 991px) { dashboard-user-bar .icon-share-bar,[data-is="dashboard-user-bar"] .icon-share-bar{ margin: 2px 5px 0px 5px; } } @media screen and (max-width: 767px) { dashboard-user-bar .dash-bar,[data-is="dashboard-user-bar"] .dash-bar{ height: auto; margin-left: auto; margin-right: auto; width: 400px; } }', '', function(opts) {
...
riot.tag2('dashboard-user-image', '<div class="col-md-6 image-container-alt"> <div class="single-item slider"> <div class="dash-banner-box" each="{ExploreBannerFilter}"> <img riot-src="{project_data.web_data.mainImg.content}" alt="{project_data.web_data.description.content}"> <div class="explore-box"> <div class="col-md-10 col-sm-8 col-xs-11"> <div class="reward-slider-push"> <div class="explore-feature-left"> <div class="dash-box-text"> <span class="dash-user-title">{name}</span> </div> <div class="dash-box-text"> <span class="dash-user-title">{project_data.info_data.reward}</span> </div> </div> </div> </div> <div class="hidden-md col-sm-4 hidden-xs dash-feature-right text-center"> <a href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><p class="learn-more">Learn More</p></a> </div> <div class="hidden-lg col-md-2 hidden-sm col-xs-1 dash-feature-right text-center"> <a href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><i class="fa fa-plus learn-more-plus"></i></a> </div> </div> </div> </div> </div>', 'dashboard-user-image .slick-slide img,[data-is="dashboard-user-image"] .slick-slide img{ width: 515px; overflow: hidden; } @media screen and (max-width: 1200px) { dashboard-user-image .slick-slide img,[data-is="dashboard-user-image"] .slick-slide img{ width: 395px; overflow: hidden; } dashboard-user-image .dash-banner-box,[data-is="dashboard-user-image"] .dash-banner-box{ height: 222px; } dashboard-user-image .reward-slider-push,[data-is="dashboard-user-image"] .reward-slider-push{ height: 212px; } dashboard-user-image .dash-feature-right,[data-is="dashboard-user-image"] .dash-feature-right{ margin-top: 187px; padding-right: 0px; } } @media screen and (max-width: 991px) { dashboard-user-image .slick-slide img,[data-is="dashboard-user-image"] .slick-slide img{ width: 615px; overflow: hidden; } dashboard-user-image .image-container-alt,[data-is="dashboard-user-image"] .image-container-alt{ border-bottom: none; } dashboard-user-image .dash-banner-box,[data-is="dashboard-user-image"] .dash-banner-box{ height: auto; border-right: 1px solid #3f434f; } dashboard-user-image .reward-slider-push,[data-is="dashboard-user-image"] .reward-slider-push{ height: 335px; } dashboard-user-image .dash-feature-right,[data-is="dashboard-user-image"] .dash-feature-right{ margin-top: 310px; padding-right: 0px; } } @media screen and (max-width: 767px) { dashboard-user-image .slick-slide img,[data-is="dashboard-user-image"] .slick-slide img{ width: 398px; overflow: hidden; } dashboard-user-image .image-container-alt,[data-is="dashboard-user-image"] .image-container-alt{ width: 400px; height: auto; margin-left: auto; margin-right: auto; } dashboard-user-image .dash-banner-box,[data-is="dashboard-user-image"] .dash-banner-box{ height: auto; border-bottom: 1px solid #3f434f; } dashboard-user-image .reward-slider-push,[data-is="dashboard-user-image"] .reward-slider-push{ height: 220px; } dashboard-user-image .dash-feature-right,[data-is="dashboard-user-image"] .dash-feature-right{ margin-top: 195px; padding-right: 8px; } }', '', function(opts) {
    krowdspace.projects.explore().then((res) =>
    {
...
riot.tag2('dashboard-user-user', '<div class="col-md-6 text-center no-gutter user-container"> <a href="#edit-profile" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn float-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-pencil fa-stack-1x fa-inverse"></i> </span> </a> <p class="dashboard-text profile-name">{firstname} {lastname}</p> <div> <div class="col-xs-4 hidden-md text-center divider-inside-right user-stat-box"> <p class="dashboard-user">Projects Launched</p> <p class="social-metric">13</p> </div> <div class="col-xs-4 hidden-md text-center divider-inside-right user-stat-box"> <p class="dashboard-user">Value of Rewards</p> <p class="social-metric">{\'$1,329\'}</p> </div> <div class="col-xs-4 hidden-md text-center user-stat-box"> <p class="dashboard-user">Project Pledges</p> <p class="social-metric">{\'$84,322\'}</p> </div> </div> <div class="col-lg-8 col-md-12 text-left"> <div class="col-md-4 col-sm-4 col-xs-4 user-box-left"> <p class="dashboard-user">Username:</p> <p class="dashboard-user">Email:</p> <p class="dashboard-user">Kickstarter:</p> <p class="dashboard-user">Indiegogo:</p> </div> <div class="col-md-8 col-sm-8 col-xs-8 user-box-right"> <p class="dashboard-user">{username}</p> <p class="dashboard-user">{email}</p> <p class="dashboard-user">{kickstarter || \'N/A\'}</p> <p class="dashboard-user">{indiegogo || \'N/A\'}</p> </div> <div class="clearfix"></div> </div> <div class="col-lg-4 hidden-md hidden-sm hidden-xs"> </div> </div>', '@media screen and (max-width: 1200px) { dashboard-user-user .user-container,[data-is="dashboard-user-user"] .user-container{ height: 224px; } } @media screen and (max-width: 991px) { dashboard-user-user .user-container,[data-is="dashboard-user-user"] .user-container{ height: 282px; width: 617px; } } @media screen and (max-width: 767px) { dashboard-user-user .user-container,[data-is="dashboard-user-user"] .user-container{ height: auto; margin-left: auto; margin-right: auto; width: 400px; border-top: none; } }', '', function(opts) {
    this.on('update', ()=>
    {
        if(!opts.user)
            return;
...
riot.tag2('project-page-title', '<div class="col-md-6 text-left no-gutter user-container-project"> <p class="dashboard-text-alt project-title">{projectTitle}</p> <p class="dashboard-text-alt hidden-md project-description">{projectDescription}</p> <p class="dashboard-text-alt project-reward-text">Reward: {projectReward}</p> <p class="dashboard-text-alt hidden-md hidden-sm project-coupon">To view the coupon code or directly link to the rewards page please follow the "Support Project button below</p> <div class="reward-position-box"> <div class="col-xs-6 text-center divider-inside-right backed-box"> <a show="{projectbtn}" href="#kickstarter-reward" class="modal-link" data-toggle="modal"><p class="back-project">BACK PROJECT</p></a> <a show="{!projectbtn}" href="{projectLink}" target="_blank"><p class="back-project">BACK PROJECT</p></a> </div> <div class="col-xs-6 text-center backed-box-right"> <p class="social-metric">{countdown || 0} DAYS LEFT</p> </div> </div> </div>', '', '', function(opts) {
    krowdspace.projects.project(this.opts.uri).then((res)=>
    {
...
riot.tag2('home-content-users', '<div id="benefits"> <div class="container"> <div class="row"> <div class="col-sm-12 text-center"> <h2 class="landing-header">Krowdspace Users</h2> </div> <div class="home-bottom col-lg-offset-2 col-lg-8 col-md-12 text-left"> <p class="user-home-box">There are a lot of benefits to <a href="#modal-global-login" class="modal-link" data-toggle="modal">becoming a member</a> at Krowdspace. By signing up you will get exclusive rewards and coupon codes for backing your favorite crowdfunding projects that are hosted on Kickstarter or Indiegogo. We always recommend that members login to Krowdspace before backing a project to see if they have submitted their campaign. We also offer crowdfunding related <a href="/#/account/giveaway" data-toggle="modal" class="modal-link home-links">giveaways</a> to our members! They are exclusive to our community and only members can register. At Krowdspace you will learn quickly that <a href="/#/explore" class="modal-link home-links">discovering new projects</a> is easy and its always fun to get extra stuff!</p> <div class="col-xs-4 text-center divider-inside-right"> <p>Projects Submitted</p> <p class="social-metric">15</p> </div> <div class="col-xs-4 text-center divider-inside-right"> <p>Value of Rewards</p> <p class="social-metric">$300</p> </div> <div class="col-xs-4 text-center"> <p>Helped Raise</p> <p class="social-metric">$5,400</p> </div> <div class="clearfix"></div> </div> </div> </div> </div>', '', '', function(opts) {
});
...
riot.tag2('home-modal-verification', '<div id="modal-verification" class="modal container fade"> <div class="krowdspace-modal col-sm-6 col-sm-offset-3"> <div id="modal" class="modal-content text-center"> <div class="modal-header"> <button type="button" class="close btn-modal" data-dismiss="modal" aria-hidden="true"> <i class="fa fa-2x fa-times text-primary" aria-hidden="true"></i> </button> </div> <div class="modal-body"> <p class="modal-heading verify-heading">Confirm Your Email Address</p> <p class="verify-message">A confirmation email has been sent to your inbox. Click on the confirmation link to verify your account.</p> </div> </div> </div> <div class="background-modal-close" data-dismiss="modal"> </div> </div>', '', '', function(opts) {
});