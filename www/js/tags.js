...
riot.tag2('dashboard-page', '<div class="row"> <global-krowdspace-navigation></global-krowdspace-navigation> </div> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <div class="container dashboard"> <div class="shadow text-left project-add-container"> <p class="project-add-text">PROJECTS</p> <div class="project-yield text-center" each="{p, index in projects}"> <project-button onclick="{makeButtF(p)}" project="{p}">{project.unique_id}</project-button> </div> <a href="/#/account/register"> <i class="fa fa-plus project-add-btn filterdark"></i> </a> </div> <dashboard-project-delete class="hidden-xs"></dashboard-project-delete> <div class="col-sm-10 col-sm-offset-1 padding-reset"> <div class="row dash-row no-gutter shadow"> <dashboard-project-image show="{project}" project="{project}"></dashboard-project-image> <dashboard-user-image show="{!project}"></dashboard-user-image> <dashboard-project-user show="{project}" index="{projectIndex + 1}" user="{user}" project="{project}"></dashboard-project-user> <dashboard-user show="{!project}" user="{user}"></dashboard-user> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-title project="{project}"> </dashboard-project-title> <dashboard-project-reward project="{project}"></dashboard-project-reward> <dashboard-project-hours project="{project}"></dashboard-project-hours> </div> <div show="{project}" class="row dash-row no-gutter"> <dashboard-project-featured project="{project}"> </dashboard-project-featured> </div> <div class="row dash-row no-gutter shadow"> <dashboard-project-wysiwyg show="{project}" project="{project}"></dashboard-project-wysiwyg> </div> <div class="row dash-row no-gutter shadow"> <dashboard-project-bar show="{project}" project="{project}"></dashboard-project-bar> <dashboard-user-bar show="{!project}"></dashboard-user-bar> </div> </div> </div> <dashboard-featured-purchase user="{user}" project="{project}"></dashboard-featured-purchase> <dashboard-explore-purchase user="{user}" project="{project}"></dashboard-explore-purchase> <dashboard-landing-purchase user="{user}" project="{project}"></dashboard-landing-purchase> <dashboard-social-purchase user="{user}" project="{project}"></dashboard-social-purchase> <dashboard-edit-profile user="{user}" project="{project}"></dashboard-edit-profile> <dashboard-edit-reward user="{user}" project="{project}"></dashboard-edit-reward> <dashboard-delete-project user="{user}" project="{project}"></dashboard-delete-project> <dashboard-refresh-content user="{user}" project="{project}"></dashboard-refresh-content> <dashboard-project-status></dashboard-project-status> <global-footer></global-footer>', '@media screen and (max-width: 767px) { dashboard-page .shadow,[data-is="dashboard-page"] .shadow{ -webkit-box-shadow: none; -moz-box-shadow: none; } dashboard-page .project-add-btn,[data-is="dashboard-page"] .project-add-btn{ width: 35px; padding: 7px 5px 9px 5px; display: inline-block; font-size: 15px; border: 1px solid #3f434f; border-left: none; } dashboard-page .project-add-btn:hover,[data-is="dashboard-page"] .project-add-btn:hover{ border: 1px solid #3f434f; border-left: none; } }', '', function(opts) {
        this.projectNum = 0;
        this.projectIndex = 0;
        this.projects = [];
...
riot.tag2('dashboard-project-delete', '<div class="col-sm-1 text-right no-gutter share-container-right"> <div class="share-box shadow" href="#delete-project" class="modal-link" data-toggle="modal"> <a onclick="{krowdspaceLogout}" title="Krowdspace Logout"> <span class="fa-stack fa-lg icon-reset krowdspace-back filterdark"> <i class="fa fa-square fa-stack-2x krowdspace"></i> <i class="fa fa-sign-out fa-stack-1x fa-inverse share-icon-push"></i> </span> </a> <a show="{project}" title="Krowdspace Remove Project"> <span class="fa-stack fa-lg icon-reset krowdspace-back-alt filterdark"> <i class="fa fa-square fa-stack-2x krowdspace-alt"></i> <i class="fa fa-trash fa-stack-1x fa-inverse share-icon-push"></i> </span> </a> </div> </div>', '', '', function(opts) {
...
riot.tag2('dashboard-project-image', '<div class="col-md-6 project-image-box padding-reset"> <img class="img-responsive project-image" ref="krowdspaceImage" src=""> <p class="funding-text funded-left">$ {raisedLocale || 0} RAISED</p> <p class="funding-text funded-right">$ {goalLocale || 0} GOAL</p> <div id="progressBar"></div> </div>', '', '', function(opts) {
    this.progBar = null;
...
riot.tag2('dashboard-user-image', '<div class="col-md-6 project-image-responsive padding-reset"> <div class="single-item slider"> <div class="landing-banner" each="{ExploreBannerFilter}"> <img class="img-responsive landing-slider" riot-src="{project_data.meta_data.mainImg}"> <div class="landing-banner-box"> <div class="col-xs-10 padding-reset"> <span class="explore-title">{name}</span> <div class="explore-box-text"> <span class="explore-title">{project_data.info_data.reward}</span> </div> </div> <div class="col-xs-2 learn-more-box text-right"> <a href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><i class="fa fa-plus learn-more-plus"></i></a> </div> </div> </div> </div> </div>', 'dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ width: 500px; height: 282px; background-color: #000; position: relative; } dashboard-user-image .landing-slider,[data-is="dashboard-user-image"] .landing-slider{ height: 282px; border: 1px solid #000; width: auto; margin-left: auto; margin-right: auto; } @media screen and (max-width: 1200px) { dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ height: 225px; width: 396px; } dashboard-user-image .landing-slider,[data-is="dashboard-user-image"] .landing-slider{ height: 225px; } } @media screen and (max-width: 991px) { dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ height: 350px; width: 616.66px; } dashboard-user-image .landing-slider,[data-is="dashboard-user-image"] .landing-slider{ height: 351px; } } @media screen and (max-width: 767px) { dashboard-user-image .project-image-responsive,[data-is="dashboard-user-image"] .project-image-responsive{ width: 400px; margin-left: auto; margin-right: auto; } dashboard-user-image .landing-banner,[data-is="dashboard-user-image"] .landing-banner{ height: 227px; width: 400px; } dashboard-user-image .landing-slider,[data-is="dashboard-user-image"] .landing-slider{ height: 228px; } }', '', function(opts) {
    krowdspace.projects.explore().then((res) =>
    {
...
riot.tag2('dashboard-user', '<div class="col-md-6 text-left no-gutter project-user-container"> <a href="#edit-profile" class="modal-link" data-toggle="modal"> <span class="fa-stack fa-lg social-btn filterdark float-btn"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-pencil fa-stack-1x fa-inverse"></i> </span> </a> <p class="profile-name capital">{firstname || \'Firstname\'} {lastname || \'Lastname\'}</p> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break">Username:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break capital">{username || \'Username\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user">Email:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user capital">{email || \'Email Address\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user user-break hidden-md">Kickstarter Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user user-break hidden-md capital">{kickstarter || \'N/A\'}</p> </div> <div class="col-sm-4 col-xs-5 user-profile-push"> <p class="dashboard-user hidden-md">Indiegogo Name:</p> </div> <div class="col-sm-8 col-xs-7"> <p class="dashboard-user hidden-md capital">{indiegogo || \'N/A\'}</p> </div> <div class="user-position-box"> <p class="dashboard-text profile-name">Krowdspace Stats</p> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Campaigns</p> <p class="social-metric">13</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Rewards</p> <p class="social-metric">{\'$1,329\'}</p> </div> <div class="col-xs-4 no-gutters text-center user-stat-box"> <p class="dashboard-user user-text-alt">Pledges</p> <p class="social-metric">{\'$84,322\'}</p> </div> </div> <div class="clearfix"></div> </div>', '@media screen and (max-width: 1200px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 225px; } } @media screen and (max-width: 991px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ height: 300px; border-left:1px solid #000; } } @media screen and (max-width: 767px) { dashboard-user .project-user-container,[data-is="dashboard-user"] .project-user-container{ width: 400px; margin-left: auto; margin-right: auto; } }', '', function(opts) {
    this.on('update', ()=>
    {
        if(!opts.user)
            return;
...
riot.tag2('explore-slider-hero', '<div class="row"> <div class="autoplay slider explore-header"> <div class="landing-banner" each="{ExploreBannerFilter}"> <img class="landing-slider" riot-src="{project_data.meta_data.mainImg}"> <div class="landing-banner-box"> <div class="col-xs-9 padding-reset"> <span class="explore-title">{name}</span> <div class="explore-box-text"> <span class="explore-title">{project_data.info_data.reward}</span> </div> </div> <div class="col-xs-3 learn-more-box text-right"> <a class="plus-switch-one" href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><p class="learn-more">Learn More</p></a> <a class="plus-switch" href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><i class="fa fa-plus learn-more-plus"></i></a> </div> </div> </div> </div> </div>', 'explore-slider-hero .landing-banner,[data-is="explore-slider-hero"] .landing-banner{ width: 550px; background-color: #000; position: relative; border-top:1px solid #000; border-bottom:1px solid #000; } explore-slider-hero .landing-slider,[data-is="explore-slider-hero"] .landing-slider{ height:310px; width: auto; margin-left: auto; margin-right: auto; } @media screen and (max-width: 550px) { explore-slider-hero .col-xs-9,[data-is="explore-slider-hero"] .col-xs-9{ width: 90%; } explore-slider-hero .col-xs-3,[data-is="explore-slider-hero"] .col-xs-3{ width: 10%; } explore-slider-hero .landing-slider,[data-is="explore-slider-hero"] .landing-slider{ height:225px; } explore-slider-hero .landing-banner,[data-is="explore-slider-hero"] .landing-banner{ width: 400px; background-color: #000; position: relative; } }', '', function(opts) {
        krowdspace.projects.explore().then((res) =>
        {
            let ExploreBannerData = res.data;
...
riot.tag2('project-page-image', '<div class="col-md-6 project-image-box padding-reset"> <img class="img-responsive project-image" ref="krowdspaceImage" src=""> <p class="funding-text funded-left">$ {raisedLocale || 0} RAISED</p> <p class="funding-text funded-right">$ {goalLocale || 0} GOAL</p> <div id="progressBar"></div> </div>', '', '', function(opts) {
    krowdspace.projects.project(this.opts.uri).then((res)=>
    {
...
riot.tag2('home-content-users', '<div id="benefits"> <div class="container"> <div class="row"> <div class="col-sm-12 text-center"> <h2 class="landing-header">Krowdspace Users</h2> </div> <div class="home-bottom col-lg-offset-2 col-lg-8 col-md-12 text-left"> <p class="user-home-box">There are a lot of benefits to <a href="#modal-global-login" class="modal-link home-links" data-toggle="modal">becoming a member</a> at Krowdspace. By registering with us you will be eligible for exclusive rewards after backing your favorite crowdfunding projects that are hosted on Kickstarter or Indiegogo. We always recommend that members login to Krowdspace before backing a project to see if it has been submitted. We also offer crowdfunding related <a href="/#/account/giveaway" data-toggle="modal" class="home-links">giveaways</a> to our members! They are exclusive to our community and only members can register. At Krowdspace you will learn quickly that <a href="/#/explore" class="home-links">discovering new projects</a> is easy and its always fun to get extra stuff!</p> <div class="col-xs-4 text-center divider-inside-right"> <p>Campaigns</p> <p class="social-metric">15</p> </div> <div class="col-xs-4 text-center divider-inside-right"> <p>Rewards</p> <p class="social-metric">$300</p> </div> <div class="col-xs-4 text-center"> <p>Pledges</p> <p class="social-metric">$5,400</p> </div> <div class="clearfix"></div> </div> </div> </div> </div>', '', '', function(opts) {
});
...
riot.tag2('home-slider-projects', '<div class="row"> <div class="autoplay slider"> <div class="landing-banner" each="{ExploreBannerFilter}"> <img class="landing-slider" riot-src="{project_data.meta_data.mainImg}"> <div class="landing-banner-box"> <div class="col-xs-9 padding-reset"> <span class="explore-title">{name}</span> <div class="explore-box-text"> <span class="explore-title">{project_data.info_data.reward}</span> </div> </div> <div class="col-xs-3 learn-more-box text-right"> <a class="plus-switch-one" href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><p class="learn-more">Learn More</p></a> <a class="plus-switch" href="{unique_url || \'/#/explore/project/\' + unique_id}" data-toggle="modal"><i class="fa fa-plus learn-more-plus"></i></a> </div> </div> </div> </div> </div>', 'home-slider-projects .landing-banner,[data-is="home-slider-projects"] .landing-banner{ width: 550px; background-color: #000; position: relative; border-top:1px solid #000; border-bottom:1px solid #000; } home-slider-projects .landing-slider,[data-is="home-slider-projects"] .landing-slider{ height:310px; width: auto; margin-left: auto; margin-right: auto; } @media screen and (max-width: 550px) { home-slider-projects .col-xs-9,[data-is="home-slider-projects"] .col-xs-9{ width: 90%; } home-slider-projects .col-xs-3,[data-is="home-slider-projects"] .col-xs-3{ width: 10%; } home-slider-projects .landing-slider,[data-is="home-slider-projects"] .landing-slider{ height:225px; } home-slider-projects .landing-banner,[data-is="home-slider-projects"] .landing-banner{ width: 400px; background-color: #000; position: relative; } }', '', function(opts) {
        krowdspace.projects.explore().then((res) =>
        {
            let ExploreBannerData = res.data,
                FilterExplore = ExploreBannerData.filter((element) => {
