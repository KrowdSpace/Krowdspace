...
riot.tag2('account-navigation', '<nav id="mainNav" class="navbar navbar-default navbar-custom navbar-alt navbar-fixed-top"> <div class="container"> <div class="navbar-header page-scroll"> <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-collapse"> <span class="sr-only">Toggle navigation</span><i class="fa fa-bars"></i> </button> <a class="navbar-logo-alt page-scroll" href="#page-top"><img src="/../img/krowdspace-explore.png" style="width:55px;"></a> </div> <div class="collapse navbar-collapse" id="navigation-collapse"> <ul class="nav navbar-nav navbar-left "> <li class="hidden"> <a href="#page-top"></a> </li> <li> <a class="page-scroll explore-scroll" href="/#explore"><span class="compass-none">Explore</a> </li> <li> <a class="page-scroll explore-scroll" href="/#account/boosts">Boosts Project</a> </li> </ul> <img class="logo-float" src="/../img/krowdspace-explore.png" style="width:55px;"> <ul class="nav navbar-nav navbar-right"> <li class="hidden"> <a href="#page-top"></a> </li> <li> <a class="page-scroll explore-scroll" href="/#account/dashboard">Dashboard</a> </li> <li> <a class="page-scroll explore-scroll" href="/#account/profile">Profile</a> </li> </ul> </div> </div> </nav> <div class="nav-push"></div>', '', '', function(opts) {
...
riot.tag2('dashboard', '<div class="row"> <account-navigation></account-navigation> </div> <div class="container-alt"> <div class="row dash-row-top"> <div class="col-fixed-4"> <modify-content-image></modify-content-image> <modify-content-reward></modify-content-reward> <modify-content-category></modify-content-category> </div> <div class="col-fixed-8 modify-content-row"> <modify-content-project></modify-content-project> </div> </div> <div class="row dash-row-bottom"> <div></div> <div class="col-sm-12"> <dash-content-backers></dash-content-backers> </div> </div> </div> <global-footer></global-footer>', '', '', function(opts) {
});
...
riot.tag2('register', '<div class="row"> <account-navigation></account-navigation> </div> <div class="container" style="margin-bottom: 50px;"> <register-content-signup></register-content-signup> <register-content-reward></register-content-reward> </div> <global-footer></global-footer>', '', '', function(opts) {
});
...
riot.tag2('explore', '<div class="row"> <explore-navigation></explore-navigation> <explore-slider-hero></explore-slider-hero> </div> <div class="container" style="margin-bottom: 50px;"> <explore-content-filter></explore-content-filter> <explore-content-card></explore-content-card> </div> <div class="row"> <global-footer></global-footer> </div>', 'explore .slider,[data-is="explore"] .slider{ width: 100%; position: relative; margin: 0px auto; } explore .slick-slide,[data-is="explore"] .slick-slide{ margin: 0px; } explore .slick-slide p,[data-is="explore"] .slick-slide p,explore .slick-slide .learn-more,[data-is="explore"] .slick-slide .learn-more{ display: none; } explore .slick-current p,[data-is="explore"] .slick-current p,explore .slick-current .learn-more,[data-is="explore"] .slick-current .learn-more{ display: block; } explore .slick-slide img,[data-is="explore"] .slick-slide img{ border-top: 1px solid #dcdedd; border-bottom: 1px solid #dcdedd; width: 750px; } explore .slick-prev:before,[data-is="explore"] .slick-prev:before,explore .slick-next:before,[data-is="explore"] .slick-next:before{ color: black; }', '', function(opts) {
});
...
riot.tag2('home', '<home-navigation></home-navigation> <home-content-hero></home-content-hero> <home-content-benefits></home-content-benefits> <home-slider-projects></home-slider-projects> <home-content-influence></home-content-influence> <home-content-boosts></home-content-boosts> <home-slider-clients></home-slider-clients> <global-footer></global-footer> <home-modal-boosts></home-modal-boosts> <home-modal-login></home-modal-login> <home-modal-rewards></home-modal-rewards> <home-modal-verification></home-modal-verification> <home-modal-submission></home-modal-submission> <global-analytics-google id="UA-92584644-1"></global-analytics-google>', '', '', function(opts) {
